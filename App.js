...
function ProfileScreen({ go, goBack, profilePhoto, setProfilePhoto, logout }) {
  ...
  // Suppression de compte : l'application ne disposant d'aucun serveur, "supprimer son
  // compte" signifie effacer l'intégralité des données stockées sur l'appareil (profil,
  // historique de pratique, journal nutritionnel, amis, séances, etc.), puis déconnecter.

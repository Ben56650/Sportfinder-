...
const FRENCH_STADIUMS = [
  { name: 'Stade de France', city: 'Saint-Denis', type: 'Football', payant: false },
  { name: 'Parc des Princes', city: 'Paris', type: 'Multisports', payant: false },
  { name: 'Stade Jean-Bouin', city: 'Paris', type: 'Football', payant: false },
  { name: 'Orange Vélodrome', city: 'Marseille', type: 'Cyclisme', payant: false },
  { name: 'Groupama Stadium', city: 'Décines-Charpieu (Lyon)', type: 'Multisports', payant: false },
  { name: 'Stade Pierre-Mauroy', city: 'Villeneuve-d’Ascq (Lille)', type: 'Football', payant: false },
  { name: 'Roazhon Park', city: 'Rennes', type: 'Multisports', payant: false },
  { name: 'Allianz Riviera', city: 'Nice', type: 'Multisports', payant: false },
  { name: 'Matmut Atlantique', city: 'Bordeaux', type: 'Multisports', payant: false },
  { name: 'Stade Geoffroy-Guichard', city: 'Saint-Étienne', type: 'Football', payant: false },
  { name: 'Stadium de Toulouse', city: 'Toulouse', type: 'Multisports', payant: false },
  { name: 'Stade de la Beaujoire', city: 'Nantes', type: 'Football', payant: false },
  { name: 'Stade Bollaert-Delelis', city: 'Lens', type: 'Football', payant: false },
  { name: 'MMArena', city: 'Le Mans', type: 'Multisports', payant: false },
  { name: 'Stade Océane', city: 'Le Havre', type: 'Football', payant: false },
  { name: 'Stade Auguste-Delaune', city: 'Reims', type: 'Football', payant: false },
  { name: 'Stade de la Mosson', city: 'Montpellier', type: 'Football', payant: false },
  { name: 'Stade Francis-Le Blé', city: 'Brest', type: 'Football', payant: false },
  { name: 'Stade Marcel-Picot', city: 'Nancy', type: 'Football', payant: false },
  { name: 'Stade Gaston-Gérard', city: 'Dijon', type: 'Football', payant: false },
  { name: 'Stade Chaban-Delmas', city: 'Bordeaux', type: 'Football', payant: false },
  { name: 'Stade Raymond-Kopa', city: 'Angers', type: 'Football', payant: false },
  { name: 'Stade de l’Aube', city: 'Troyes', type: 'Football', payant: false },
  { name: 'Stade du Moustoir', city: 'Lorient', type: 'Football', payant: false },
  { name: 'Stade Michel-d’Ornano', city: 'Caen', type: 'Football', payant: false },
  { name: 'Stade Saint-Symphorien', city: 'Metz', type: 'Football', payant: false },
  { name: 'Stade Charléty', city: 'Paris', type: 'Football', payant: false },
  { name: 'Vélodrome Jacques-Anquetil', city: 'Paris', type: 'Cyclisme', payant: false },
  { name: 'Stade Robert-Diochon', city: 'Rouen', type: 'Football', payant: false },
  { name: 'Stade de l’Abbé-Deschamps', city: 'Auxerre', type: 'Football', payant: false },
  { name: 'Stade Marcel-Verchère', city: 'Grenoble', type: 'Football', payant: false },
  { name: 'Stade des Alpes', city: 'Grenoble', type: 'Football', payant: false },
  { name: 'Stade Nungesser', city: 'Valenciennes', type: 'Football', payant: false },
  { name: 'Stade Léon-Bollée', city: 'Le Mans', type: 'Football', payant: false },
  { name: 'Stade Rugby Marcel-Michelin', city: 'Clermont-Ferrand', type: 'Rugby', payant: false },
  { name: 'Stade Ernest-Wallon', city: 'Toulouse', type: 'Football', payant: false },
  { name: 'Stade Jean-Dauger', city: 'Bayonne', type: 'Football', payant: false },
  { name: 'Stade Aimé-Giral', city: 'Perpignan', type: 'Football', payant: false },
  { name: 'Stade Chaban-Delmas Rugby', city: 'Bordeaux', type: 'Rugby', payant: false },
  { name: 'Parc des Sports Perpignan', city: 'Perpignan', type: 'Multisports', payant: false },
  { name: 'Stade Municipal', city: 'Aubervilliers', type: 'Football', payant: false },
  { name: 'Stade Pierre-de-Coubertin', city: 'Paris', type: 'Football', payant: false },
  { name: 'Stade Sébastien-Charléty', city: 'Paris', type: 'Football', payant: false },
  { name: 'Stade Yves-du-Manoir', city: 'Colombes', type: 'Football', payant: false },
  { name: 'Stade Marville', city: 'La Courneuve', type: 'Football', payant: false },
  { name: 'Stade Delaune', city: 'Reims', type: 'Football', payant: false },
  { name: 'Stade Ferdinand-Bracke', city: 'Wattignies', type: 'Football', payant: false },
  { name: 'Complexe Sportif Duvauchelle', city: 'Créteil', type: 'Multisports', payant: false },
  { name: 'Stade Municipal de Rodez', city: 'Rodez', type: 'Football', payant: false },
  { name: 'Stade de l’Est', city: 'Amiens', type: 'Football', payant: false },
  { name: 'Tennis Club de Paris', city: 'Paris', type: 'Tennis', payant: true },
  { name: 'Roland-Garros', city: 'Paris', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Boulogne-Billancourt', city: 'Boulogne-Billancourt', type: 'Tennis', payant: true },
  { name: 'Complexe Sportif Carpentier', city: 'Paris', type: 'Multisports', payant: false },
  { name: 'Gymnase Japy', city: 'Paris', type: 'Multisports', payant: false },
  { name: 'Palais des Sports de Paris', city: 'Paris', type: 'Multisports', payant: false },
  { name: 'Halle Georges-Carpentier', city: 'Paris', type: 'Multisports', payant: false },
  { name: 'Piscine Joséphine-Baker', city: 'Paris', type: 'Piscine', payant: false },
  { name: 'Piscine Molitor', city: 'Paris', type: 'Piscine', payant: false },
  { name: 'Piscine Pontoise', city: 'Paris', type: 'Piscine', payant: false },
  { name: 'Bois de Vincennes — Pistes de course', city: 'Paris', type: 'Athlétisme', payant: false },
  { name: 'Bois de Boulogne — Pistes de course', city: 'Paris', type: 'Athlétisme', payant: false },
  { name: 'Parc Monceau', city: 'Paris', type: 'Multisports', payant: false },
  { name: 'Parc des Buttes-Chaumont', city: 'Paris', type: 'Multisports', payant: false },
  { name: 'Bercy Arena (Accor Arena)', city: 'Paris', type: 'Multisports', payant: false },
  { name: 'Vélodrome National de Saint-Quentin', city: 'Saint-Quentin-en-Yvelines', type: 'Cyclisme', payant: false },
  { name: 'Salle Pierre-de-Coubertin (Basket)', city: 'Paris', type: 'Basketball', payant: false },
  { name: 'Dojo Paris Budokan', city: 'Paris', type: 'Arts martiaux', payant: true },
  { name: 'Climbing District', city: 'Paris', type: 'Multisports', payant: false },
  { name: 'Arkose Nation (Escalade)', city: 'Paris', type: 'Escalade', payant: true },
  { name: 'Vertical Art Bastille (Escalade)', city: 'Paris', type: 'Escalade', payant: true },
  { name: 'Basket Hall des Halles', city: 'Paris', type: 'Basketball', payant: false },
  { name: 'Studio Danse Le Central', city: 'Paris', type: 'Multisports', payant: false },
  { name: 'Tennis Club de Lyon', city: 'Lyon', type: 'Tennis', payant: true },
  { name: 'Halle Tony-Garnier', city: 'Lyon', type: 'Multisports', payant: false },
  { name: 'Piscine du Rhône', city: 'Lyon', type: 'Piscine', payant: false },
  { name: 'Parc de la Tête d’Or — Pistes de course', city: 'Lyon', type: 'Athlétisme', payant: false },
  { name: 'Arkose Confluence (Escalade)', city: 'Lyon', type: 'Escalade', payant: true },
  { name: 'Gymnase Mermoz', city: 'Lyon', type: 'Multisports', payant: false },
  { name: 'Plage du Prado — Beach Sports', city: 'Marseille', type: 'Multisports', payant: false },
  { name: 'Parc Borély — Pistes de course', city: 'Marseille', type: 'Athlétisme', payant: false },
  { name: 'Palais Omnisports Marseille Grand-Est', city: 'Marseille', type: 'Multisports', payant: false },
  { name: 'Piscine du Vallon Régny', city: 'Marseille', type: 'Piscine', payant: false },
  { name: 'Tennis Club de Marseille', city: 'Marseille', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Toulouse', city: 'Toulouse', type: 'Tennis', payant: true },
  { name: 'Piscine Nakache', city: 'Toulouse', type: 'Piscine', payant: false },
  { name: 'Prairie des Filtres — Pistes de course', city: 'Toulouse', type: 'Athlétisme', payant: false },
  { name: 'Promenade des Anglais — Piste cyclable/course', city: 'Nice', type: 'Athlétisme', payant: false },
  { name: 'Palais des Sports Jean-Bouin', city: 'Nice', type: 'Multisports', payant: false },
  { name: 'Tennis Club de Nice', city: 'Nice', type: 'Tennis', payant: true },
  { name: 'Île de Nantes — Complexe sportif', city: 'Nantes', type: 'Multisports', payant: false },
  { name: 'Piscine Léo-Lagrange', city: 'Nantes', type: 'Piscine', payant: false },
  { name: 'Parc de Procé', city: 'Nantes', type: 'Multisports', payant: false },
  { name: 'Parc de l’Orangerie — Pistes de course', city: 'Strasbourg', type: 'Athlétisme', payant: false },
  { name: 'Rhénus Sport', city: 'Strasbourg', type: 'Multisports', payant: false },
  { name: 'Piscine du Wacken', city: 'Strasbourg', type: 'Piscine', payant: false },
  { name: 'Parc du Château de la Mogère', city: 'Montpellier', type: 'Multisports', payant: false },
  { name: 'Arena Sud de France', city: 'Montpellier', type: 'Multisports', payant: false },
  { name: 'Piscine Olympique d’Antigone', city: 'Montpellier', type: 'Piscine', payant: false },
  { name: 'Jardin Public — Pistes de course', city: 'Bordeaux', type: 'Athlétisme', payant: false },
  { name: 'Piscine Judaïque', city: 'Bordeaux', type: 'Piscine', payant: false },
  { name: 'Arkose Bordeaux (Escalade)', city: 'Bordeaux', type: 'Escalade', payant: true },
  { name: 'Stade Pierre-Mauroy — Espace Fitness', city: 'Lille', type: 'Football', payant: false },
  { name: 'Piscine Marx-Dormoy', city: 'Lille', type: 'Piscine', payant: false },
  { name: 'Parc de la Citadelle — Pistes de course', city: 'Lille', type: 'Athlétisme', payant: false },
  { name: 'Piscine Bréquigny', city: 'Rennes', type: 'Piscine', payant: false },
  { name: 'Tennis Club de Rennes', city: 'Rennes', type: 'Tennis', payant: true },
  { name: 'Parc du Thabor', city: 'Rennes', type: 'Multisports', payant: false },
  { name: 'Gymnase Vern-Poterie', city: 'Rennes', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif René-Tys', city: 'Reims', type: 'Multisports', payant: false },
  { name: 'Piscine Château-d’Eau', city: 'Reims', type: 'Piscine', payant: false },
  { name: 'Parc de Champagne', city: 'Reims', type: 'Multisports', payant: false },
  { name: 'Piscine Nancy-Thermal', city: 'Nancy', type: 'Piscine', payant: false },
  { name: 'Parc de la Pépinière', city: 'Nancy', type: 'Multisports', payant: false },
  { name: 'Gymnase Poincaré', city: 'Nancy', type: 'Multisports', payant: false },
  { name: 'Piscine Olympique de Metz', city: 'Metz', type: 'Piscine', payant: false },
  { name: 'Parc de la Seille', city: 'Metz', type: 'Multisports', payant: false },
  { name: 'Les Arènes de Metz', city: 'Metz', type: 'Multisports', payant: false },
  { name: 'Piscine Olympique de Dijon', city: 'Dijon', type: 'Piscine', payant: false },
  { name: 'Parc de la Colombière', city: 'Dijon', type: 'Multisports', payant: false },
  { name: 'Palais des Sports Jean-Michel-Geoffroy', city: 'Dijon', type: 'Multisports', payant: false },
  { name: 'Piscine du Lac de Maine', city: 'Angers', type: 'Piscine', payant: false },
  { name: 'Complexe Sportif Jean-Bouin', city: 'Angers', type: 'Multisports', payant: false },
  { name: 'Lac de Maine — Base de plein air', city: 'Angers', type: 'Multisports', payant: false },
  { name: 'Piscine Jean-Boiteux', city: 'Le Mans', type: 'Piscine', payant: false },
  { name: 'Antarès (Salle omnisports)', city: 'Le Mans', type: 'Multisports', payant: false },
  { name: 'Piscine des Bains des Docks', city: 'Le Havre', type: 'Piscine', payant: false },
  { name: 'Plage du Havre — Beach Sports', city: 'Le Havre', type: 'Multisports', payant: false },
  { name: 'Piscine Aqua Vikings', city: 'Caen', type: 'Piscine', payant: false },
  { name: 'Zénith de Caen — Espace sportif', city: 'Caen', type: 'Multisports', payant: false },
  { name: 'Parc de la Colline aux Oiseaux', city: 'Caen', type: 'Multisports', payant: false },
  { name: 'Piscine Iris', city: 'Grenoble', type: 'Piscine', payant: false },
  { name: 'Tennis Club de Grenoble', city: 'Grenoble', type: 'Tennis', payant: true },
  { name: 'Parc Paul-Mistral', city: 'Grenoble', type: 'Multisports', payant: false },
  { name: 'Piscine Océanide', city: 'Clermont-Ferrand', type: 'Piscine', payant: false },
  { name: 'Parc Montjuzet', city: 'Clermont-Ferrand', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif Georges-Pompidou', city: 'Clermont-Ferrand', type: 'Multisports', payant: false },
  { name: 'Piscine Marius-Patinaud', city: 'Saint-Étienne', type: 'Piscine', payant: false },
  { name: 'Parc de l’Europe', city: 'Saint-Étienne', type: 'Multisports', payant: false },
  { name: 'Palais des Sports André-Brouat', city: 'Toulouse', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif du Grand Rond', city: 'Toulouse', type: 'Multisports', payant: false },
  { name: 'Piscine Nikaïa', city: 'Nice', type: 'Piscine', payant: false },
  { name: 'Parc Chambrun', city: 'Nice', type: 'Multisports', payant: false },
  { name: 'Arkose Nice (Escalade)', city: 'Nice', type: 'Escalade', payant: true },
  { name: 'Piscine Galin', city: 'Bordeaux', type: 'Piscine', payant: false },
  { name: 'Parc Bordelais', city: 'Bordeaux', type: 'Multisports', payant: false },
  { name: 'Palais des Sports de Bordeaux', city: 'Bordeaux', type: 'Multisports', payant: false },
  { name: 'Piscine Petit Port', city: 'Nantes', type: 'Piscine', payant: false },
  { name: 'Tennis Club de Nantes', city: 'Nantes', type: 'Tennis', payant: true },
  { name: 'Arkose Nantes (Escalade)', city: 'Nantes', type: 'Escalade', payant: true },
  { name: 'Dojo Marseille Provence', city: 'Marseille', type: 'Arts martiaux', payant: true },
  { name: 'Complexe Sportif du Roucas Blanc', city: 'Marseille', type: 'Multisports', payant: false },
  { name: 'Arkose Marseille (Escalade)', city: 'Marseille', type: 'Escalade', payant: true },
  { name: 'Piscine du Rhône (bassin extérieur)', city: 'Lyon', type: 'Piscine', payant: false },
  { name: 'Palais des Sports de Lyon (Gerland)', city: 'Lyon', type: 'Multisports', payant: false },
  { name: 'Parc de Gerland', city: 'Lyon', type: 'Multisports', payant: false },
  { name: 'Piscine Georges-Vallerey', city: 'Paris', type: 'Piscine', payant: false },
  { name: 'Piscine Keller', city: 'Paris', type: 'Piscine', payant: false },
  { name: 'Stade Suzanne-Lenglen', city: 'Paris', type: 'Football', payant: false },
  { name: 'Stade Emile-Anthoine', city: 'Paris', type: 'Football', payant: false },
  { name: 'Palais des Sports Paris (Porte de Versailles)', city: 'Paris', type: 'Multisports', payant: false },
  { name: 'Skatepark de Bercy', city: 'Paris', type: 'Skate / Roller', payant: false },
  { name: 'Piste d’Athlétisme du Stade Charléty', city: 'Paris', type: 'Athlétisme', payant: false },
  { name: 'Piscine de Kehl (frontalière)', city: 'Strasbourg', type: 'Piscine', payant: false },
  { name: 'Tennis Club de Strasbourg', city: 'Strasbourg', type: 'Tennis', payant: true },
  { name: 'Parc de Pourtalès', city: 'Strasbourg', type: 'Multisports', payant: false },
  { name: 'Piscine Antigone (bassin extérieur)', city: 'Montpellier', type: 'Piscine', payant: false },
  { name: 'Parc du Lunaret', city: 'Montpellier', type: 'Multisports', payant: false },
  { name: 'Piscine Marx-Dormoy (bassin sportif)', city: 'Lille', type: 'Piscine', payant: false },
  { name: 'Tennis Club de Lille', city: 'Lille', type: 'Tennis', payant: true },
  { name: 'Stade des Costières', city: 'Nîmes', type: 'Football', payant: false },
  { name: 'Piscine Aquatropic', city: 'Nîmes', type: 'Piscine', payant: false },
  { name: 'Stade Léo-Lagrange', city: 'Avignon', type: 'Football', payant: false },
  { name: 'Piscine de la Barbière', city: 'Avignon', type: 'Piscine', payant: false },
  { name: 'Stade de la Vallée du Cher', city: 'Tours', type: 'Football', payant: false },
  { name: 'Piscine du Lac', city: 'Tours', type: 'Piscine', payant: false },
  { name: 'Stade Omnisports d’Orléans', city: 'Orléans', type: 'Football', payant: false },
  { name: 'Piscine de la Source', city: 'Orléans', type: 'Piscine', payant: false },
  { name: 'Stade de Beaublanc', city: 'Limoges', type: 'Football', payant: false },
  { name: 'Piscine Aquapolis', city: 'Limoges', type: 'Piscine', payant: false },
  { name: 'Stade Rébeilleau', city: 'Poitiers', type: 'Football', payant: false },
  { name: 'Piscine des Ilots', city: 'Poitiers', type: 'Piscine', payant: false },
  { name: 'Stade du Hameau', city: 'Pau', type: 'Football', payant: false },
  { name: 'Piscine Municipale de Pau', city: 'Pau', type: 'Piscine', payant: false },
  { name: 'Piscine des Marquisats', city: 'Annecy', type: 'Piscine', payant: false },
  { name: 'Lac d’Annecy — Base sportive', city: 'Annecy', type: 'Multisports', payant: false },
  { name: 'Stade Léo-Lagrange (Besançon)', city: 'Besançon', type: 'Football', payant: false },
  { name: 'Piscine Mallarmé', city: 'Besançon', type: 'Piscine', payant: false },
  { name: 'Stade de l’Ill', city: 'Mulhouse', type: 'Football', payant: false },
  { name: 'Piscine des Sports de Mulhouse', city: 'Mulhouse', type: 'Piscine', payant: false },
  { name: 'Stade Mayol', city: 'Toulon', type: 'Football', payant: false },
  { name: 'Plage du Mourillon — Beach Sports', city: 'Toulon', type: 'Multisports', payant: false },
  { name: 'Stade Marcel-Saupin', city: 'Saint-Nazaire', type: 'Football', payant: false },
  { name: 'Piscine Aquasport', city: 'Saint-Nazaire', type: 'Piscine', payant: false },
  { name: 'Stade de Chambéry', city: 'Chambéry', type: 'Football', payant: false },
  { name: 'Piscine Chambéry Métropole', city: 'Chambéry', type: 'Piscine', payant: false },
  { name: 'Stade Marcel-Deflandre', city: 'La Rochelle', type: 'Football', payant: false },
  { name: 'Plage de La Rochelle — Beach Sports', city: 'La Rochelle', type: 'Multisports', payant: false },
  { name: 'Stade de la Méditerranée', city: 'Béziers', type: 'Football', payant: false },
  { name: 'Piscine de Béziers', city: 'Béziers', type: 'Piscine', payant: false },
  { name: 'Stade de l’Épopée', city: 'Calais', type: 'Football', payant: false },
  { name: 'Plage de Calais — Beach Sports', city: 'Calais', type: 'Multisports', payant: false },
  { name: 'Stade Paul-Guerre', city: 'Dunkerque', type: 'Football', payant: false },
  { name: 'Piscine Paul-Asseman', city: 'Dunkerque', type: 'Piscine', payant: false },
  { name: 'Stade de la Rabine', city: 'Vannes', type: 'Football', payant: false },
  { name: 'Piscine de Vannes', city: 'Vannes', type: 'Piscine', payant: false },
  { name: 'Stade de Penvillers', city: 'Quimper', type: 'Football', payant: false },
  { name: 'Piscine Aquarive', city: 'Quimper', type: 'Piscine', payant: false },
  { name: 'Stade Pierre-de-Coubertin (Cannes)', city: 'Cannes', type: 'Football', payant: false },
  { name: 'Plage de Cannes — Beach Sports', city: 'Cannes', type: 'Multisports', payant: false },
  { name: 'Stade du Fort Carré', city: 'Antibes', type: 'Football', payant: false },
  { name: 'Plage d’Antibes — Beach Sports', city: 'Antibes', type: 'Multisports', payant: false },
  { name: 'Stade Ange-Susini', city: 'Ajaccio', type: 'Football', payant: false },
  { name: 'Plage d’Ajaccio — Beach Sports', city: 'Ajaccio', type: 'Multisports', payant: false },
  { name: 'Stade Armand-Cesari', city: 'Bastia', type: 'Football', payant: false },
  { name: 'Plage de Bastia — Beach Sports', city: 'Bastia', type: 'Multisports', payant: false },
  { name: 'Stade Marville de Saint-Malo', city: 'Saint-Malo', type: 'Football', payant: false },
  { name: 'Plage du Sillon — Beach Sports', city: 'Saint-Malo', type: 'Multisports', payant: false },
  { name: 'Stade Aguilera', city: 'Biarritz', type: 'Football', payant: false },
  { name: 'Plage de Biarritz — Beach Sports', city: 'Biarritz', type: 'Multisports', payant: false },
  { name: 'Stade Carcassonne (Aix)', city: 'Aix-en-Provence', type: 'Football', payant: false },
  { name: 'Piscine Yves-Blanc', city: 'Aix-en-Provence', type: 'Piscine', payant: false },
  { name: 'Stade Chanzy', city: 'Angoulême', type: 'Football', payant: false },
  { name: 'Stade René-Gaillard', city: 'Niort', type: 'Football', payant: false },
  { name: 'Stade Jacques-Duclos', city: 'Bourges', type: 'Football', payant: false },
  { name: 'Stade Gaston-Petit', city: 'Châteauroux', type: 'Football', payant: false },
  { name: 'Stade Fournier', city: 'Blois', type: 'Football', payant: false },
  { name: 'Stade Jacques-Couvret', city: 'Chartres', type: 'Football', payant: false },
  { name: 'Stade Municipal de Compiègne', city: 'Compiègne', type: 'Football', payant: false },
  { name: 'Stade Pierre-Brisson', city: 'Beauvais', type: 'Football', payant: false },
  { name: 'Stade Francis-Le Basser', city: 'Laval', type: 'Football', payant: false },
  { name: 'Stade Bonnin', city: 'Cholet', type: 'Football', payant: false },
  { name: 'Stade Fred-Aubert', city: 'Saint-Brieuc', type: 'Football', payant: false },
  { name: 'Stade Pierre-Bayenet', city: 'Douai', type: 'Football', payant: false },
  { name: 'Stade Coutaud', city: 'Béthune', type: 'Football', payant: false },
  { name: 'Stade Michelin', city: 'Arras', type: 'Football', payant: false },
  { name: 'Stade Alfred-Danel', city: 'Cambrai', type: 'Football', payant: false },
  { name: 'Stade Charles-Jaeger', city: 'Charleville-Mézières', type: 'Football', payant: false },
  { name: 'Stade Colombière', city: 'Épinal', type: 'Football', payant: false },
  { name: 'Stade Serzian', city: 'Belfort', type: 'Football', payant: false },
  { name: 'Stade Léo-Lagrange (Chalon-sur-Saône)', city: 'Chalon-sur-Saône', type: 'Football', payant: false },
  { name: 'Stade Léo-Lagrange (Mâcon)', city: 'Mâcon', type: 'Football', payant: false },
  { name: 'Stade Marcel-Verchère (Bourg-en-Bresse)', city: 'Bourg-en-Bresse', type: 'Football', payant: false },
  { name: 'Stade André-Champavier', city: 'Roanne', type: 'Football', payant: false },
  { name: 'Stade Darragon', city: 'Vichy', type: 'Football', payant: false },
  { name: 'Stade Le Bourru', city: 'Montluçon', type: 'Football', payant: false },
  { name: 'Stade Jean-Alric', city: 'Aurillac', type: 'Football', payant: false },
  { name: 'Stade Massot', city: 'Le Puy-en-Velay', type: 'Football', payant: false },
  { name: 'Stadium Municipal d’Albi', city: 'Albi', type: 'Multisports', payant: false },
  { name: 'Stade Pierre-Antoine', city: 'Castres', type: 'Football', payant: false },
  { name: 'Stade Sapiac', city: 'Montauban', type: 'Football', payant: false },
  { name: 'Stade Armandie', city: 'Agen', type: 'Football', payant: false },
  { name: 'Stade Albert-Domec', city: 'Carcassonne', type: 'Football', payant: false },
  { name: 'Parc des Sports et de l’Amitié', city: 'Narbonne', type: 'Multisports', payant: false },
  { name: 'Stade Louis-Michel', city: 'Sète', type: 'Football', payant: false },
  { name: 'Stade Pierre-Pibarot', city: 'Alès', type: 'Football', payant: false },
  { name: 'Stade Guy-Nublat', city: 'Gap', type: 'Football', payant: false },
  { name: 'Stade Marcel-Sembat', city: 'Fréjus', type: 'Football', payant: false },
  { name: 'Stade des Salins', city: 'Hyères', type: 'Football', payant: false },
  { name: 'Stade Francis-Turcan', city: 'Martigues', type: 'Football', payant: false },
  { name: 'Stade Roger-Couderc', city: 'Salon-de-Provence', type: 'Football', payant: false },
  { name: 'Stade Fernand-Fournier', city: 'Arles', type: 'Football', payant: false },
  { name: 'Stade Georges-Pompidou', city: 'Valence', type: 'Football', payant: false },
  { name: 'Stade Georges-Lyvet', city: 'Villeurbanne', type: 'Football', payant: false },
  { name: 'Complexe Sportif de Thonon', city: 'Thonon-les-Bains', type: 'Multisports', payant: false },
  { name: 'Stade Pierre-Bertholat', city: 'Épernay', type: 'Football', payant: false },
  { name: 'Stade Jean-Marin', city: 'Évreux', type: 'Football', payant: false },
  { name: 'Stade Calmette', city: 'Saint-Lô', type: 'Football', payant: false },
  { name: 'Stade Claude-Herzog', city: 'Cherbourg-en-Cotentin', type: 'Football', payant: false },
  { name: 'Stade Marcel-Bertrand', city: 'Alençon', type: 'Football', payant: false },
  { name: 'Stade Henri-Desgrange', city: 'La Roche-sur-Yon', type: 'Football', payant: false },
  { name: 'Complexe Sportif Municipal de Paris', city: 'Paris', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Paris', city: 'Paris', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Paris', city: 'Paris', type: 'Piscine', payant: false },
  { name: 'City Stade de Paris', city: 'Paris', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Lyon', city: 'Lyon', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Lyon', city: 'Lyon', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Lyon', city: 'Lyon', type: 'Piscine', payant: false },
  { name: 'City Stade de Lyon', city: 'Lyon', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Marseille', city: 'Marseille', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Marseille', city: 'Marseille', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Marseille', city: 'Marseille', type: 'Piscine', payant: false },
  { name: 'City Stade de Marseille', city: 'Marseille', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Lille', city: 'Lille', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Lille', city: 'Lille', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Lille', city: 'Lille', type: 'Piscine', payant: false },
  { name: 'City Stade de Lille', city: 'Lille', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Toulouse', city: 'Toulouse', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Toulouse', city: 'Toulouse', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Toulouse', city: 'Toulouse', type: 'Piscine', payant: false },
  { name: 'City Stade de Toulouse', city: 'Toulouse', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Nice', city: 'Nice', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Nice', city: 'Nice', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Nice', city: 'Nice', type: 'Piscine', payant: false },
  { name: 'City Stade de Nice', city: 'Nice', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Bordeaux', city: 'Bordeaux', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Bordeaux', city: 'Bordeaux', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Bordeaux', city: 'Bordeaux', type: 'Piscine', payant: false },
  { name: 'City Stade de Bordeaux', city: 'Bordeaux', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Nantes', city: 'Nantes', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Nantes', city: 'Nantes', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Nantes', city: 'Nantes', type: 'Piscine', payant: false },
  { name: 'City Stade de Nantes', city: 'Nantes', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Strasbourg', city: 'Strasbourg', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Strasbourg', city: 'Strasbourg', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Strasbourg', city: 'Strasbourg', type: 'Piscine', payant: false },
  { name: 'City Stade de Strasbourg', city: 'Strasbourg', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Rennes', city: 'Rennes', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Rennes', city: 'Rennes', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Rennes', city: 'Rennes', type: 'Piscine', payant: false },
  { name: 'City Stade de Rennes', city: 'Rennes', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Montpellier', city: 'Montpellier', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Montpellier', city: 'Montpellier', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Montpellier', city: 'Montpellier', type: 'Piscine', payant: false },
  { name: 'City Stade de Montpellier', city: 'Montpellier', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Grenoble', city: 'Grenoble', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Grenoble', city: 'Grenoble', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Grenoble', city: 'Grenoble', type: 'Piscine', payant: false },
  { name: 'City Stade de Grenoble', city: 'Grenoble', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Reims', city: 'Reims', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Reims', city: 'Reims', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Reims', city: 'Reims', type: 'Piscine', payant: false },
  { name: 'City Stade de Reims', city: 'Reims', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Le Havre', city: 'Le Havre', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Le Havre', city: 'Le Havre', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Le Havre', city: 'Le Havre', type: 'Piscine', payant: false },
  { name: 'City Stade de Le Havre', city: 'Le Havre', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Rouen', city: 'Rouen', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Rouen', city: 'Rouen', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Rouen', city: 'Rouen', type: 'Piscine', payant: false },
  { name: 'City Stade de Rouen', city: 'Rouen', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Nancy', city: 'Nancy', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Nancy', city: 'Nancy', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Nancy', city: 'Nancy', type: 'Piscine', payant: false },
  { name: 'City Stade de Nancy', city: 'Nancy', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Metz', city: 'Metz', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Metz', city: 'Metz', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Metz', city: 'Metz', type: 'Piscine', payant: false },
  { name: 'City Stade de Metz', city: 'Metz', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Dijon', city: 'Dijon', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Dijon', city: 'Dijon', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Dijon', city: 'Dijon', type: 'Piscine', payant: false },
  { name: 'City Stade de Dijon', city: 'Dijon', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Angers', city: 'Angers', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Angers', city: 'Angers', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Angers', city: 'Angers', type: 'Piscine', payant: false },
  { name: 'City Stade de Angers', city: 'Angers', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Caen', city: 'Caen', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Caen', city: 'Caen', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Caen', city: 'Caen', type: 'Piscine', payant: false },
  { name: 'City Stade de Caen', city: 'Caen', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Brest', city: 'Brest', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Brest', city: 'Brest', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Brest', city: 'Brest', type: 'Piscine', payant: false },
  { name: 'City Stade de Brest', city: 'Brest', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Toulon', city: 'Toulon', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Toulon', city: 'Toulon', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Toulon', city: 'Toulon', type: 'Piscine', payant: false },
  { name: 'City Stade de Toulon', city: 'Toulon', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Clermont-Ferrand', city: 'Clermont-Ferrand', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Clermont-Ferrand', city: 'Clermont-Ferrand', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Clermont-Ferrand', city: 'Clermont-Ferrand', type: 'Piscine', payant: false },
  { name: 'City Stade de Clermont-Ferrand', city: 'Clermont-Ferrand', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Perpignan', city: 'Perpignan', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Perpignan', city: 'Perpignan', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Perpignan', city: 'Perpignan', type: 'Piscine', payant: false },
  { name: 'City Stade de Perpignan', city: 'Perpignan', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Amiens', city: 'Amiens', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Amiens', city: 'Amiens', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Amiens', city: 'Amiens', type: 'Piscine', payant: false },
  { name: 'City Stade de Amiens', city: 'Amiens', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Limoges', city: 'Limoges', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Limoges', city: 'Limoges', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Limoges', city: 'Limoges', type: 'Piscine', payant: false },
  { name: 'City Stade de Limoges', city: 'Limoges', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Tours', city: 'Tours', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Tours', city: 'Tours', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Tours', city: 'Tours', type: 'Piscine', payant: false },
  { name: 'City Stade de Tours', city: 'Tours', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Orléans', city: 'Orléans', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Orléans', city: 'Orléans', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Orléans', city: 'Orléans', type: 'Piscine', payant: false },
  { name: 'City Stade de Orléans', city: 'Orléans', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Besançon', city: 'Besançon', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Besançon', city: 'Besançon', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Besançon', city: 'Besançon', type: 'Piscine', payant: false },
  { name: 'City Stade de Besançon', city: 'Besançon', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Mulhouse', city: 'Mulhouse', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Mulhouse', city: 'Mulhouse', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Mulhouse', city: 'Mulhouse', type: 'Piscine', payant: false },
  { name: 'City Stade de Mulhouse', city: 'Mulhouse', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Saint-Étienne', city: 'Saint-Étienne', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Saint-Étienne', city: 'Saint-Étienne', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Saint-Étienne', city: 'Saint-Étienne', type: 'Piscine', payant: false },
  { name: 'City Stade de Saint-Étienne', city: 'Saint-Étienne', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Annecy', city: 'Annecy', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Annecy', city: 'Annecy', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Annecy', city: 'Annecy', type: 'Piscine', payant: false },
  { name: 'City Stade de Annecy', city: 'Annecy', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Pau', city: 'Pau', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Pau', city: 'Pau', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Pau (Pau)', city: 'Pau', type: 'Piscine', payant: false },
  { name: 'City Stade de Pau', city: 'Pau', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Bayonne', city: 'Bayonne', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Bayonne', city: 'Bayonne', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Bayonne', city: 'Bayonne', type: 'Piscine', payant: false },
  { name: 'City Stade de Bayonne', city: 'Bayonne', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de La Rochelle', city: 'La Rochelle', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de La Rochelle', city: 'La Rochelle', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de La Rochelle', city: 'La Rochelle', type: 'Piscine', payant: false },
  { name: 'City Stade de La Rochelle', city: 'La Rochelle', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Béziers', city: 'Béziers', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Béziers', city: 'Béziers', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Béziers', city: 'Béziers', type: 'Piscine', payant: false },
  { name: 'City Stade de Béziers', city: 'Béziers', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Nîmes', city: 'Nîmes', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Nîmes', city: 'Nîmes', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Nîmes', city: 'Nîmes', type: 'Piscine', payant: false },
  { name: 'City Stade de Nîmes', city: 'Nîmes', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Avignon', city: 'Avignon', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Avignon', city: 'Avignon', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Avignon', city: 'Avignon', type: 'Piscine', payant: false },
  { name: 'City Stade de Avignon', city: 'Avignon', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Troyes', city: 'Troyes', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Troyes', city: 'Troyes', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Troyes', city: 'Troyes', type: 'Piscine', payant: false },
  { name: 'City Stade de Troyes', city: 'Troyes', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Valenciennes', city: 'Valenciennes', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Valenciennes', city: 'Valenciennes', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Valenciennes', city: 'Valenciennes', type: 'Piscine', payant: false },
  { name: 'City Stade de Valenciennes', city: 'Valenciennes', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Dunkerque', city: 'Dunkerque', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Dunkerque', city: 'Dunkerque', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Dunkerque', city: 'Dunkerque', type: 'Piscine', payant: false },
  { name: 'City Stade de Dunkerque', city: 'Dunkerque', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Calais', city: 'Calais', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Calais', city: 'Calais', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Calais', city: 'Calais', type: 'Piscine', payant: false },
  { name: 'City Stade de Calais', city: 'Calais', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Vannes', city: 'Vannes', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Vannes', city: 'Vannes', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Vannes', city: 'Vannes', type: 'Piscine', payant: false },
  { name: 'City Stade de Vannes', city: 'Vannes', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Quimper', city: 'Quimper', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Quimper', city: 'Quimper', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Quimper', city: 'Quimper', type: 'Piscine', payant: false },
  { name: 'City Stade de Quimper', city: 'Quimper', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Cannes', city: 'Cannes', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Cannes', city: 'Cannes', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Cannes', city: 'Cannes', type: 'Piscine', payant: false },
  { name: 'City Stade de Cannes', city: 'Cannes', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Antibes', city: 'Antibes', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Antibes', city: 'Antibes', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Antibes', city: 'Antibes', type: 'Piscine', payant: false },
  { name: 'City Stade de Antibes', city: 'Antibes', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Biarritz', city: 'Biarritz', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Biarritz', city: 'Biarritz', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Biarritz', city: 'Biarritz', type: 'Piscine', payant: false },
  { name: 'City Stade de Biarritz', city: 'Biarritz', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Saint-Malo', city: 'Saint-Malo', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Saint-Malo', city: 'Saint-Malo', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Saint-Malo', city: 'Saint-Malo', type: 'Piscine', payant: false },
  { name: 'City Stade de Saint-Malo', city: 'Saint-Malo', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Chambéry', city: 'Chambéry', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Chambéry', city: 'Chambéry', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Chambéry', city: 'Chambéry', type: 'Piscine', payant: false },
  { name: 'City Stade de Chambéry', city: 'Chambéry', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Créteil', city: 'Créteil', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Créteil', city: 'Créteil', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Créteil', city: 'Créteil', type: 'Piscine', payant: false },
  { name: 'City Stade de Créteil', city: 'Créteil', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Colombes', city: 'Colombes', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Colombes', city: 'Colombes', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Colombes', city: 'Colombes', type: 'Piscine', payant: false },
  { name: 'City Stade de Colombes', city: 'Colombes', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Villeurbanne', city: 'Villeurbanne', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Villeurbanne', city: 'Villeurbanne', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Villeurbanne', city: 'Villeurbanne', type: 'Piscine', payant: false },
  { name: 'City Stade de Villeurbanne', city: 'Villeurbanne', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Valence', city: 'Valence', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Valence', city: 'Valence', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Valence', city: 'Valence', type: 'Piscine', payant: false },
  { name: 'City Stade de Valence', city: 'Valence', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Angoulême', city: 'Angoulême', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Angoulême', city: 'Angoulême', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Angoulême', city: 'Angoulême', type: 'Piscine', payant: false },
  { name: 'City Stade de Angoulême', city: 'Angoulême', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Niort', city: 'Niort', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Niort', city: 'Niort', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Niort', city: 'Niort', type: 'Piscine', payant: false },
  { name: 'City Stade de Niort', city: 'Niort', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Bourges', city: 'Bourges', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Bourges', city: 'Bourges', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Bourges', city: 'Bourges', type: 'Piscine', payant: false },
  { name: 'City Stade de Bourges', city: 'Bourges', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Châteauroux', city: 'Châteauroux', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Châteauroux', city: 'Châteauroux', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Châteauroux', city: 'Châteauroux', type: 'Piscine', payant: false },
  { name: 'City Stade de Châteauroux', city: 'Châteauroux', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Blois', city: 'Blois', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Blois', city: 'Blois', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Blois', city: 'Blois', type: 'Piscine', payant: false },
  { name: 'City Stade de Blois', city: 'Blois', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Chartres', city: 'Chartres', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Chartres', city: 'Chartres', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Chartres', city: 'Chartres', type: 'Piscine', payant: false },
  { name: 'City Stade de Chartres', city: 'Chartres', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Compiègne', city: 'Compiègne', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Compiègne', city: 'Compiègne', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Compiègne', city: 'Compiègne', type: 'Piscine', payant: false },
  { name: 'City Stade de Compiègne', city: 'Compiègne', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Beauvais', city: 'Beauvais', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Beauvais', city: 'Beauvais', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Beauvais', city: 'Beauvais', type: 'Piscine', payant: false },
  { name: 'City Stade de Beauvais', city: 'Beauvais', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Laval', city: 'Laval', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Laval', city: 'Laval', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Laval', city: 'Laval', type: 'Piscine', payant: false },
  { name: 'City Stade de Laval', city: 'Laval', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Cholet', city: 'Cholet', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Cholet', city: 'Cholet', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Cholet', city: 'Cholet', type: 'Piscine', payant: false },
  { name: 'City Stade de Cholet', city: 'Cholet', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Saint-Brieuc', city: 'Saint-Brieuc', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Saint-Brieuc', city: 'Saint-Brieuc', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Saint-Brieuc', city: 'Saint-Brieuc', type: 'Piscine', payant: false },
  { name: 'City Stade de Saint-Brieuc', city: 'Saint-Brieuc', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Douai', city: 'Douai', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Douai', city: 'Douai', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Douai', city: 'Douai', type: 'Piscine', payant: false },
  { name: 'City Stade de Douai', city: 'Douai', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Béthune', city: 'Béthune', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Béthune', city: 'Béthune', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Béthune', city: 'Béthune', type: 'Piscine', payant: false },
  { name: 'City Stade de Béthune', city: 'Béthune', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Arras', city: 'Arras', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Arras', city: 'Arras', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Arras', city: 'Arras', type: 'Piscine', payant: false },
  { name: 'City Stade de Arras', city: 'Arras', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Cambrai', city: 'Cambrai', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Cambrai', city: 'Cambrai', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Cambrai', city: 'Cambrai', type: 'Piscine', payant: false },
  { name: 'City Stade de Cambrai', city: 'Cambrai', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Charleville-Mézières', city: 'Charleville-Mézières', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Charleville-Mézières', city: 'Charleville-Mézières', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Charleville-Mézières', city: 'Charleville-Mézières', type: 'Piscine', payant: false },
  { name: 'City Stade de Charleville-Mézières', city: 'Charleville-Mézières', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Épinal', city: 'Épinal', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Épinal', city: 'Épinal', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Épinal', city: 'Épinal', type: 'Piscine', payant: false },
  { name: 'City Stade de Épinal', city: 'Épinal', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Belfort', city: 'Belfort', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Belfort', city: 'Belfort', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Belfort', city: 'Belfort', type: 'Piscine', payant: false },
  { name: 'City Stade de Belfort', city: 'Belfort', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Chalon-sur-Saône', city: 'Chalon-sur-Saône', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Chalon-sur-Saône', city: 'Chalon-sur-Saône', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Chalon-sur-Saône', city: 'Chalon-sur-Saône', type: 'Piscine', payant: false },
  { name: 'City Stade de Chalon-sur-Saône', city: 'Chalon-sur-Saône', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Mâcon', city: 'Mâcon', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Mâcon', city: 'Mâcon', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Mâcon', city: 'Mâcon', type: 'Piscine', payant: false },
  { name: 'City Stade de Mâcon', city: 'Mâcon', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Bourg-en-Bresse', city: 'Bourg-en-Bresse', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Bourg-en-Bresse', city: 'Bourg-en-Bresse', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Bourg-en-Bresse', city: 'Bourg-en-Bresse', type: 'Piscine', payant: false },
  { name: 'City Stade de Bourg-en-Bresse', city: 'Bourg-en-Bresse', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Roanne', city: 'Roanne', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Roanne', city: 'Roanne', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Roanne', city: 'Roanne', type: 'Piscine', payant: false },
  { name: 'City Stade de Roanne', city: 'Roanne', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Vichy', city: 'Vichy', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Vichy', city: 'Vichy', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Vichy', city: 'Vichy', type: 'Piscine', payant: false },
  { name: 'City Stade de Vichy', city: 'Vichy', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Montluçon', city: 'Montluçon', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Montluçon', city: 'Montluçon', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Montluçon', city: 'Montluçon', type: 'Piscine', payant: false },
  { name: 'City Stade de Montluçon', city: 'Montluçon', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Aurillac', city: 'Aurillac', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Aurillac', city: 'Aurillac', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Aurillac', city: 'Aurillac', type: 'Piscine', payant: false },
  { name: 'City Stade de Aurillac', city: 'Aurillac', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Le Puy-en-Velay', city: 'Le Puy-en-Velay', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Le Puy-en-Velay', city: 'Le Puy-en-Velay', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Le Puy-en-Velay', city: 'Le Puy-en-Velay', type: 'Piscine', payant: false },
  { name: 'City Stade de Le Puy-en-Velay', city: 'Le Puy-en-Velay', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Albi', city: 'Albi', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Albi', city: 'Albi', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Albi', city: 'Albi', type: 'Piscine', payant: false },
  { name: 'City Stade de Albi', city: 'Albi', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Castres', city: 'Castres', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Castres', city: 'Castres', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Castres', city: 'Castres', type: 'Piscine', payant: false },
  { name: 'City Stade de Castres', city: 'Castres', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Montauban', city: 'Montauban', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Montauban', city: 'Montauban', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Montauban', city: 'Montauban', type: 'Piscine', payant: false },
  { name: 'City Stade de Montauban', city: 'Montauban', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Agen', city: 'Agen', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Agen', city: 'Agen', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Agen', city: 'Agen', type: 'Piscine', payant: false },
  { name: 'City Stade de Agen', city: 'Agen', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Carcassonne', city: 'Carcassonne', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Carcassonne', city: 'Carcassonne', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Carcassonne', city: 'Carcassonne', type: 'Piscine', payant: false },
  { name: 'City Stade de Carcassonne', city: 'Carcassonne', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Narbonne', city: 'Narbonne', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Narbonne', city: 'Narbonne', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Narbonne', city: 'Narbonne', type: 'Piscine', payant: false },
  { name: 'City Stade de Narbonne', city: 'Narbonne', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Sète', city: 'Sète', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Sète', city: 'Sète', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Sète', city: 'Sète', type: 'Piscine', payant: false },
  { name: 'City Stade de Sète', city: 'Sète', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Alès', city: 'Alès', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Alès', city: 'Alès', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Alès', city: 'Alès', type: 'Piscine', payant: false },
  { name: 'City Stade de Alès', city: 'Alès', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Gap', city: 'Gap', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Gap', city: 'Gap', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Gap', city: 'Gap', type: 'Piscine', payant: false },
  { name: 'City Stade de Gap', city: 'Gap', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Fréjus', city: 'Fréjus', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Fréjus', city: 'Fréjus', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Fréjus', city: 'Fréjus', type: 'Piscine', payant: false },
  { name: 'City Stade de Fréjus', city: 'Fréjus', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Hyères', city: 'Hyères', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Hyères', city: 'Hyères', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Hyères', city: 'Hyères', type: 'Piscine', payant: false },
  { name: 'City Stade de Hyères', city: 'Hyères', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Martigues', city: 'Martigues', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Martigues', city: 'Martigues', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Martigues', city: 'Martigues', type: 'Piscine', payant: false },
  { name: 'City Stade de Martigues', city: 'Martigues', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Salon-de-Provence', city: 'Salon-de-Provence', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Salon-de-Provence', city: 'Salon-de-Provence', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Salon-de-Provence', city: 'Salon-de-Provence', type: 'Piscine', payant: false },
  { name: 'City Stade de Salon-de-Provence', city: 'Salon-de-Provence', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Arles', city: 'Arles', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Arles', city: 'Arles', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Arles', city: 'Arles', type: 'Piscine', payant: false },
  { name: 'City Stade de Arles', city: 'Arles', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Thonon-les-Bains', city: 'Thonon-les-Bains', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Thonon-les-Bains', city: 'Thonon-les-Bains', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Thonon-les-Bains', city: 'Thonon-les-Bains', type: 'Piscine', payant: false },
  { name: 'City Stade de Thonon-les-Bains', city: 'Thonon-les-Bains', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Épernay', city: 'Épernay', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Épernay', city: 'Épernay', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Épernay', city: 'Épernay', type: 'Piscine', payant: false },
  { name: 'City Stade de Épernay', city: 'Épernay', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Évreux', city: 'Évreux', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Évreux', city: 'Évreux', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Évreux', city: 'Évreux', type: 'Piscine', payant: false },
  { name: 'City Stade de Évreux', city: 'Évreux', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Saint-Lô', city: 'Saint-Lô', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Saint-Lô', city: 'Saint-Lô', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Saint-Lô', city: 'Saint-Lô', type: 'Piscine', payant: false },
  { name: 'City Stade de Saint-Lô', city: 'Saint-Lô', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Cherbourg-en-Cotentin', city: 'Cherbourg-en-Cotentin', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Cherbourg-en-Cotentin', city: 'Cherbourg-en-Cotentin', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Cherbourg-en-Cotentin', city: 'Cherbourg-en-Cotentin', type: 'Piscine', payant: false },
  { name: 'City Stade de Cherbourg-en-Cotentin', city: 'Cherbourg-en-Cotentin', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de Alençon', city: 'Alençon', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de Alençon', city: 'Alençon', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de Alençon', city: 'Alençon', type: 'Piscine', payant: false },
  { name: 'City Stade de Alençon', city: 'Alençon', type: 'City stade', payant: false },
  { name: 'Complexe Sportif Municipal de La Roche-sur-Yon', city: 'La Roche-sur-Yon', type: 'Multisports', payant: false },
  { name: 'Gymnase Municipal de La Roche-sur-Yon', city: 'La Roche-sur-Yon', type: 'Multisports', payant: false },
  { name: 'Piscine Municipale de La Roche-sur-Yon', city: 'La Roche-sur-Yon', type: 'Piscine', payant: false },
  { name: 'City Stade de La Roche-sur-Yon', city: 'La Roche-sur-Yon', type: 'City stade', payant: false },
  { name: 'Centre Équestre de la Butte Mortemart', city: 'Paris', type: 'Équitation', payant: true },
  { name: 'Centre Équestre du Bois de Boulogne', city: 'Paris', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Vincennes', city: 'Paris', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Marseille', city: 'Marseille', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Lyon', city: 'Lyon', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Bordeaux', city: 'Bordeaux', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Lille', city: 'Lille', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Strasbourg', city: 'Strasbourg', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Nice', city: 'Nice', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Toulouse', city: 'Toulouse', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Nantes', city: 'Nantes', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Montpellier', city: 'Montpellier', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Rennes', city: 'Rennes', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Grenoble', city: 'Grenoble', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Reims', city: 'Reims', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Dijon', city: 'Dijon', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Caen', city: 'Caen', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Rouen', city: 'Rouen', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Tours', city: 'Tours', type: 'Équitation', payant: true },
  { name: 'Piscine Olympique de Marseille', city: 'Marseille', type: 'Piscine', payant: true },
  { name: 'Piscine de Lyon', city: 'Lyon', type: 'Piscine', payant: true },
  { name: 'Piscine de Bordeaux', city: 'Bordeaux', type: 'Piscine', payant: true },
  { name: 'Piscine de Lille', city: 'Lille', type: 'Piscine', payant: true },
  { name: 'Piscine de Strasbourg', city: 'Strasbourg', type: 'Piscine', payant: true },
  { name: 'Piscine de Nice', city: 'Nice', type: 'Piscine', payant: true },
  { name: 'Piscine de Toulouse', city: 'Toulouse', type: 'Piscine', payant: true },
  { name: 'Piscine de Nantes', city: 'Nantes', type: 'Piscine', payant: true },
  { name: 'Piscine de Montpellier', city: 'Montpellier', type: 'Piscine', payant: true },
  { name: 'Piscine de Rennes', city: 'Rennes', type: 'Piscine', payant: true },
  { name: 'Basic-Fit Paris Bastille', city: 'Paris', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Marseille Centre', city: 'Marseille', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Lyon Part-Dieu', city: 'Lyon', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Bordeaux', city: 'Bordeaux', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Lille', city: 'Lille', type: 'Salle de sport', payant: true },
  { name: 'Fitness Park Paris', city: 'Paris', type: 'Salle de sport', payant: true },
  { name: 'Fitness Park Marseille', city: 'Marseille', type: 'Salle de sport', payant: true },
  { name: 'Fitness Park Lyon', city: 'Lyon', type: 'Salle de sport', payant: true },
  { name: 'Neoness Paris', city: 'Paris', type: 'Salle de sport', payant: true },
  { name: 'Neoness Marseille', city: 'Marseille', type: 'Salle de sport', payant: true },
  { name: 'Keep Cool Paris', city: 'Paris', type: 'Salle de sport', payant: true },
  { name: 'Keep Cool Lyon', city: 'Lyon', type: 'Salle de sport', payant: true },
  { name: 'Golf de Paris', city: 'Paris', type: 'Golf', payant: true },
  { name: 'Golf de Marseille', city: 'Marseille', type: 'Golf', payant: true },
  { name: 'Golf de Lyon', city: 'Lyon', type: 'Golf', payant: true },
  { name: 'Golf de Bordeaux', city: 'Bordeaux', type: 'Golf', payant: true },
  { name: 'Golf de Lille', city: 'Lille', type: 'Golf', payant: true },
  { name: 'Golf de Strasbourg', city: 'Strasbourg', type: 'Golf', payant: true },
  { name: 'Golf de Nice', city: 'Nice', type: 'Golf', payant: true },
  { name: 'Golf de Toulouse', city: 'Toulouse', type: 'Golf', payant: true },
  { name: 'Golf de Nantes', city: 'Nantes', type: 'Golf', payant: true },
  { name: 'Golf de Montpellier', city: 'Montpellier', type: 'Golf', payant: true },
  { name: 'Skatepark de Paris', city: 'Paris', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Marseille', city: 'Marseille', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Lyon', city: 'Lyon', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Bordeaux', city: 'Bordeaux', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Lille', city: 'Lille', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Strasbourg', city: 'Strasbourg', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Nice', city: 'Nice', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Toulouse', city: 'Toulouse', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Nantes', city: 'Nantes', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Montpellier', city: 'Montpellier', type: 'Skate / Roller', payant: false },
  { name: 'Salle de Badminton Paris', city: 'Paris', type: 'Badminton', payant: true },
  { name: 'Salle de Badminton Marseille', city: 'Marseille', type: 'Badminton', payant: true },
  { name: 'Salle de Badminton Lyon', city: 'Lyon', type: 'Badminton', payant: true },
  { name: 'Salle de Badminton Bordeaux', city: 'Bordeaux', type: 'Badminton', payant: true },
  { name: 'Salle de Badminton Lille', city: 'Lille', type: 'Badminton', payant: true },
  { name: 'Dojo de Paris', city: 'Paris', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Marseille', city: 'Marseille', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Lyon', city: 'Lyon', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Bordeaux', city: 'Bordeaux', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Lille', city: 'Lille', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Strasbourg', city: 'Strasbourg', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Nice', city: 'Nice', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Toulouse', city: 'Toulouse', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Nantes', city: 'Nantes', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Montpellier', city: 'Montpellier', type: 'Arts martiaux', payant: true },
  { name: 'Hippodrome de Paris-Vincennes', city: 'Paris', type: 'Hippisme', payant: true },
  { name: 'Hippodrome de Marseille', city: 'Marseille', type: 'Hippisme', payant: true },
  { name: 'Hippodrome de Lyon', city: 'Lyon', type: 'Hippisme', payant: true },
  { name: 'Hippodrome de Bordeaux', city: 'Bordeaux', type: 'Hippisme', payant: true },
  { name: 'Hippodrome de Lille', city: 'Lille', type: 'Hippisme', payant: true },
  { name: 'Terrain de Volleyball Paris', city: 'Paris', type: 'Volleyball', payant: false },
  { name: 'Terrain de Volleyball Marseille', city: 'Marseille', type: 'Volleyball', payant: false },
  { name: 'Terrain de Volleyball Lyon', city: 'Lyon', type: 'Volleyball', payant: false },
  { name: 'Terrain de Volleyball Bordeaux', city: 'Bordeaux', type: 'Volleyball', payant: false },
  { name: 'Terrain de Volleyball Lille', city: 'Lille', type: 'Volleyball', payant: false },
  { name: 'Salle de Handball Paris', city: 'Paris', type: 'Handball', payant: false },
  { name: 'Salle de Handball Marseille', city: 'Marseille', type: 'Handball', payant: false },
  { name: 'Salle de Handball Lyon', city: 'Lyon', type: 'Handball', payant: false },
  { name: 'Salle de Handball Bordeaux', city: 'Bordeaux', type: 'Handball', payant: false },
  { name: 'Salle de Handball Lille', city: 'Lille', type: 'Handball', payant: false },
  { name: 'Centre Équestre de Saint-Étienne', city: 'Saint-Étienne', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Le Havre', city: 'Le Havre', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Toulon', city: 'Toulon', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Angers', city: 'Angers', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Villeurbanne', city: 'Villeurbanne', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Saint-Denis', city: 'Saint-Denis', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Le Mans', city: 'Le Mans', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Aix-en-Provence', city: 'Aix-en-Provence', type: 'Équitation', payant: true },
  { name: 'Piscine de Saint-Étienne', city: 'Saint-Étienne', type: 'Piscine', payant: true },
  { name: 'Piscine de Le Havre', city: 'Le Havre', type: 'Piscine', payant: true },
  { name: 'Piscine de Toulon', city: 'Toulon', type: 'Piscine', payant: true },
  { name: 'Piscine de Grenoble', city: 'Grenoble', type: 'Piscine', payant: true },
  { name: 'Piscine de Dijon', city: 'Dijon', type: 'Piscine', payant: true },
  { name: 'Piscine de Angers', city: 'Angers', type: 'Piscine', payant: true },
  { name: 'Piscine de Villeurbanne', city: 'Villeurbanne', type: 'Piscine', payant: true },
  { name: 'Piscine de Saint-Denis', city: 'Saint-Denis', type: 'Piscine', payant: true },
  { name: 'Piscine de Le Mans', city: 'Le Mans', type: 'Piscine', payant: true },
  { name: 'Piscine de Aix-en-Provence', city: 'Aix-en-Provence', type: 'Piscine', payant: true },
  { name: 'Basic-Fit Saint-Étienne', city: 'Saint-Étienne', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Le Havre', city: 'Le Havre', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Toulon', city: 'Toulon', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Grenoble', city: 'Grenoble', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Dijon', city: 'Dijon', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Angers', city: 'Angers', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Villeurbanne', city: 'Villeurbanne', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Saint-Denis', city: 'Saint-Denis', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Le Mans', city: 'Le Mans', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Aix-en-Provence', city: 'Aix-en-Provence', type: 'Salle de sport', payant: true },
  { name: 'Fitness Park Saint-Étienne', city: 'Saint-Étienne', type: 'Salle de sport', payant: true },
  { name: 'Fitness Park Le Havre', city: 'Le Havre', type: 'Salle de sport', payant: true },
  { name: 'Fitness Park Toulon', city: 'Toulon', type: 'Salle de sport', payant: true },
  { name: 'Fitness Park Grenoble', city: 'Grenoble', type: 'Salle de sport', payant: true },
  { name: 'Fitness Park Dijon', city: 'Dijon', type: 'Salle de sport', payant: true },
  { name: 'Fitness Park Angers', city: 'Angers', type: 'Salle de sport', payant: true },
  { name: 'Fitness Park Villeurbanne', city: 'Villeurbanne', type: 'Salle de sport', payant: true },
  { name: 'Fitness Park Saint-Denis', city: 'Saint-Denis', type: 'Salle de sport', payant: true },
  { name: 'Fitness Park Le Mans', city: 'Le Mans', type: 'Salle de sport', payant: true },
  { name: 'Fitness Park Aix-en-Provence', city: 'Aix-en-Provence', type: 'Salle de sport', payant: true },
  { name: 'Golf de Saint-Étienne', city: 'Saint-Étienne', type: 'Golf', payant: true },
  { name: 'Golf de Le Havre', city: 'Le Havre', type: 'Golf', payant: true },
  { name: 'Golf de Toulon', city: 'Toulon', type: 'Golf', payant: true },
  { name: 'Golf de Grenoble', city: 'Grenoble', type: 'Golf', payant: true },
  { name: 'Golf de Dijon', city: 'Dijon', type: 'Golf', payant: true },
  { name: 'Golf de Angers', city: 'Angers', type: 'Golf', payant: true },
  { name: 'Golf de Villeurbanne', city: 'Villeurbanne', type: 'Golf', payant: true },
  { name: 'Golf de Saint-Denis', city: 'Saint-Denis', type: 'Golf', payant: true },
  { name: 'Golf de Le Mans', city: 'Le Mans', type: 'Golf', payant: true },
  { name: 'Golf de Aix-en-Provence', city: 'Aix-en-Provence', type: 'Golf', payant: true },
  { name: 'Skatepark de Saint-Étienne', city: 'Saint-Étienne', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Le Havre', city: 'Le Havre', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Toulon', city: 'Toulon', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Grenoble', city: 'Grenoble', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Dijon', city: 'Dijon', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Angers', city: 'Angers', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Villeurbanne', city: 'Villeurbanne', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Saint-Denis', city: 'Saint-Denis', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Le Mans', city: 'Le Mans', type: 'Skate / Roller', payant: false },
  { name: 'Skatepark de Aix-en-Provence', city: 'Aix-en-Provence', type: 'Skate / Roller', payant: false },
  { name: 'Salle de Badminton Saint-Étienne', city: 'Saint-Étienne', type: 'Badminton', payant: true },
  { name: 'Salle de Badminton Le Havre', city: 'Le Havre', type: 'Badminton', payant: true },
  { name: 'Salle de Badminton Toulon', city: 'Toulon', type: 'Badminton', payant: true },
  { name: 'Salle de Badminton Grenoble', city: 'Grenoble', type: 'Badminton', payant: true },
  { name: 'Salle de Badminton Dijon', city: 'Dijon', type: 'Badminton', payant: true },
  { name: 'Dojo de Saint-Étienne', city: 'Saint-Étienne', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Le Havre', city: 'Le Havre', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Toulon', city: 'Toulon', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Grenoble', city: 'Grenoble', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Dijon', city: 'Dijon', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Angers', city: 'Angers', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Villeurbanne', city: 'Villeurbanne', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Saint-Denis', city: 'Saint-Denis', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Le Mans', city: 'Le Mans', type: 'Arts martiaux', payant: true },
  { name: 'Dojo de Aix-en-Provence', city: 'Aix-en-Provence', type: 'Arts martiaux', payant: true },
  { name: 'Hippodrome de Saint-Étienne', city: 'Saint-Étienne', type: 'Hippisme', payant: true },
  { name: 'Hippodrome de Le Havre', city: 'Le Havre', type: 'Hippisme', payant: true },
  { name: 'Hippodrome de Toulon', city: 'Toulon', type: 'Hippisme', payant: true },
  { name: 'Hippodrome de Grenoble', city: 'Grenoble', type: 'Hippisme', payant: true },
  { name: 'Hippodrome de Dijon', city: 'Dijon', type: 'Hippisme', payant: true },
  { name: 'Terrain de Volleyball Saint-Étienne', city: 'Saint-Étienne', type: 'Volleyball', payant: false },
  { name: 'Terrain de Volleyball Le Havre', city: 'Le Havre', type: 'Volleyball', payant: false },
  { name: 'Terrain de Volleyball Toulon', city: 'Toulon', type: 'Volleyball', payant: false },
  { name: 'Terrain de Volleyball Grenoble', city: 'Grenoble', type: 'Volleyball', payant: false },
  { name: 'Terrain de Volleyball Dijon', city: 'Dijon', type: 'Volleyball', payant: false },
  { name: 'Salle de Handball Saint-Étienne', city: 'Saint-Étienne', type: 'Handball', payant: false },
  { name: 'Salle de Handball Le Havre', city: 'Le Havre', type: 'Handball', payant: false },
  { name: 'Salle de Handball Toulon', city: 'Toulon', type: 'Handball', payant: false },
  { name: 'Salle de Handball Grenoble', city: 'Grenoble', type: 'Handball', payant: false },
  { name: 'Salle de Handball Dijon', city: 'Dijon', type: 'Handball', payant: false },
  { name: 'Stade de Rugby Saint-Étienne', city: 'Saint-Étienne', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Le Havre', city: 'Le Havre', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Toulon', city: 'Toulon', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Grenoble', city: 'Grenoble', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Dijon', city: 'Dijon', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Angers', city: 'Angers', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Villeurbanne', city: 'Villeurbanne', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Saint-Denis', city: 'Saint-Denis', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Le Mans', city: 'Le Mans', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Aix-en-Provence', city: 'Aix-en-Provence', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Brest', city: 'Brest', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Perpignan', city: 'Perpignan', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Metz', city: 'Metz', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Besançon', city: 'Besançon', type: 'Rugby', payant: false },
  { name: 'Stade de Rugby Orléans', city: 'Orléans', type: 'Rugby', payant: false },
  { name: 'Terrain de Basketball Saint-Étienne', city: 'Saint-Étienne', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Le Havre', city: 'Le Havre', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Toulon', city: 'Toulon', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Grenoble', city: 'Grenoble', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Dijon', city: 'Dijon', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Angers', city: 'Angers', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Villeurbanne', city: 'Villeurbanne', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Saint-Denis', city: 'Saint-Denis', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Le Mans', city: 'Le Mans', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Aix-en-Provence', city: 'Aix-en-Provence', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Brest', city: 'Brest', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Perpignan', city: 'Perpignan', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Metz', city: 'Metz', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Besançon', city: 'Besançon', type: 'Basketball', payant: false },
  { name: 'Terrain de Basketball Orléans', city: 'Orléans', type: 'Basketball', payant: false },
  { name: 'Vélodrome de Saint-Étienne', city: 'Saint-Étienne', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Le Havre', city: 'Le Havre', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Toulon', city: 'Toulon', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Grenoble', city: 'Grenoble', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Dijon', city: 'Dijon', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Angers', city: 'Angers', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Villeurbanne', city: 'Villeurbanne', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Saint-Denis', city: 'Saint-Denis', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Le Mans', city: 'Le Mans', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Aix-en-Provence', city: 'Aix-en-Provence', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Brest', city: 'Brest', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Perpignan', city: 'Perpignan', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Metz', city: 'Metz', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Besançon', city: 'Besançon', type: 'Cyclisme', payant: false },
  { name: 'Vélodrome de Orléans', city: 'Orléans', type: 'Cyclisme', payant: false },
  { name: 'Tennis Club de Saint-Étienne', city: 'Saint-Étienne', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Le Havre', city: 'Le Havre', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Toulon', city: 'Toulon', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Dijon', city: 'Dijon', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Angers', city: 'Angers', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Villeurbanne', city: 'Villeurbanne', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Saint-Denis', city: 'Saint-Denis', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Le Mans', city: 'Le Mans', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Aix-en-Provence', city: 'Aix-en-Provence', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Brest', city: 'Brest', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Perpignan', city: 'Perpignan', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Metz', city: 'Metz', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Besançon', city: 'Besançon', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Orléans', city: 'Orléans', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Rouen', city: 'Rouen', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Mulhouse', city: 'Mulhouse', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Caen', city: 'Caen', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Nancy', city: 'Nancy', type: 'Tennis', payant: true },
  { name: 'Tennis Club de Tourcoing', city: 'Tourcoing', type: 'Tennis', payant: true },
  { name: 'City Stade de Saint-Denis', city: 'Saint-Denis', type: 'City stade', payant: false },
  { name: 'City Stade de Le Mans', city: 'Le Mans', type: 'City stade', payant: false },
  { name: 'City Stade de Aix-en-Provence', city: 'Aix-en-Provence', type: 'City stade', payant: false },
  { name: 'City Stade de Tourcoing', city: 'Tourcoing', type: 'City stade', payant: false },
  { name: 'Stade Municipal de Saint-Étienne', city: 'Saint-Étienne', type: 'Football', payant: false },
  { name: 'Stade Municipal de Le Havre', city: 'Le Havre', type: 'Football', payant: false },
  { name: 'Stade Municipal de Toulon', city: 'Toulon', type: 'Football', payant: false },
  { name: 'Stade Municipal de Grenoble', city: 'Grenoble', type: 'Football', payant: false },
  { name: 'Stade Municipal de Dijon', city: 'Dijon', type: 'Football', payant: false },
  { name: 'Stade Municipal de Angers', city: 'Angers', type: 'Football', payant: false },
  { name: 'Stade Municipal de Villeurbanne', city: 'Villeurbanne', type: 'Football', payant: false },
  { name: 'Stade Municipal de Saint-Denis', city: 'Saint-Denis', type: 'Football', payant: false },
  { name: 'Stade Municipal de Le Mans', city: 'Le Mans', type: 'Football', payant: false },
  { name: 'Stade Municipal de Aix-en-Provence', city: 'Aix-en-Provence', type: 'Football', payant: false },
  { name: 'Stade Municipal de Brest', city: 'Brest', type: 'Football', payant: false },
  { name: 'Stade Municipal de Perpignan', city: 'Perpignan', type: 'Football', payant: false },
  { name: 'Stade Municipal de Metz', city: 'Metz', type: 'Football', payant: false },
  { name: 'Stade Municipal de Besançon', city: 'Besançon', type: 'Football', payant: false },
  { name: 'Stade Municipal de Orléans', city: 'Orléans', type: 'Football', payant: false },
  { name: 'Stade Municipal de Rouen', city: 'Rouen', type: 'Football', payant: false },
  { name: 'Stade Municipal de Mulhouse', city: 'Mulhouse', type: 'Football', payant: false },
  { name: 'Stade Municipal de Caen', city: 'Caen', type: 'Football', payant: false },
  { name: 'Stade Municipal de Nancy', city: 'Nancy', type: 'Football', payant: false },
  { name: 'Stade Municipal de Tourcoing', city: 'Tourcoing', type: 'Football', payant: false },
  { name: 'Complexe Sportif de Saint-Étienne', city: 'Saint-Étienne', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Le Havre', city: 'Le Havre', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Toulon', city: 'Toulon', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Grenoble', city: 'Grenoble', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Dijon', city: 'Dijon', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Angers', city: 'Angers', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Villeurbanne', city: 'Villeurbanne', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Saint-Denis', city: 'Saint-Denis', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Le Mans', city: 'Le Mans', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Aix-en-Provence', city: 'Aix-en-Provence', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Brest', city: 'Brest', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Perpignan', city: 'Perpignan', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Metz', city: 'Metz', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Besançon', city: 'Besançon', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Orléans', city: 'Orléans', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Rouen', city: 'Rouen', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Mulhouse', city: 'Mulhouse', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Caen', city: 'Caen', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Nancy', city: 'Nancy', type: 'Multisports', payant: false },
  { name: 'Complexe Sportif de Tourcoing', city: 'Tourcoing', type: 'Multisports', payant: false },
  { name: 'Piscine de Brest', city: 'Brest', type: 'Piscine', payant: true },
  { name: 'Piscine de Perpignan', city: 'Perpignan', type: 'Piscine', payant: true },
  { name: 'Piscine de Metz', city: 'Metz', type: 'Piscine', payant: true },
  { name: 'Piscine de Besançon', city: 'Besançon', type: 'Piscine', payant: true },
  { name: 'Piscine de Orléans', city: 'Orléans', type: 'Piscine', payant: true },
  { name: 'Piscine de Rouen', city: 'Rouen', type: 'Piscine', payant: true },
  { name: 'Piscine de Mulhouse', city: 'Mulhouse', type: 'Piscine', payant: true },
  { name: 'Piscine de Caen', city: 'Caen', type: 'Piscine', payant: true },
  { name: 'Piscine de Nancy', city: 'Nancy', type: 'Piscine', payant: true },
  { name: 'Piscine de Tourcoing', city: 'Tourcoing', type: 'Piscine', payant: true },
  { name: 'Centre Équestre de Brest', city: 'Brest', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Perpignan', city: 'Perpignan', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Metz', city: 'Metz', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Besançon', city: 'Besançon', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Orléans', city: 'Orléans', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Mulhouse', city: 'Mulhouse', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Nancy', city: 'Nancy', type: 'Équitation', payant: true },
  { name: 'Centre Équestre de Tourcoing', city: 'Tourcoing', type: 'Équitation', payant: true },
  { name: 'Basic-Fit Brest', city: 'Brest', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Perpignan', city: 'Perpignan', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Metz', city: 'Metz', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Besançon', city: 'Besançon', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Orléans', city: 'Orléans', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Rouen', city: 'Rouen', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Mulhouse', city: 'Mulhouse', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Caen', city: 'Caen', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Nancy', city: 'Nancy', type: 'Salle de sport', payant: true },
  { name: 'Basic-Fit Tourcoing', city: 'Tourcoing', type: 'Salle de sport', payant: true },
  { name: 'Salle de Musculation Paris 1', city: 'Paris', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Paris 2', city: 'Paris', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Paris 3', city: 'Paris', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Marseille 1', city: 'Marseille', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Marseille 2', city: 'Marseille', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Lyon 1', city: 'Lyon', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Lyon 2', city: 'Lyon', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Bordeaux 1', city: 'Bordeaux', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Bordeaux 2', city: 'Bordeaux', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Lille 1', city: 'Lille', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Lille 2', city: 'Lille', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Strasbourg 1', city: 'Strasbourg', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Strasbourg 2', city: 'Strasbourg', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Nice 1', city: 'Nice', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Nice 2', city: 'Nice', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Toulouse 1', city: 'Toulouse', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Toulouse 2', city: 'Toulouse', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Nantes 1', city: 'Nantes', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Nantes 2', city: 'Nantes', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Montpellier 1', city: 'Montpellier', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Montpellier 2', city: 'Montpellier', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Rennes 1', city: 'Rennes', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Rennes 2', city: 'Rennes', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Reims 1', city: 'Reims', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Reims 2', city: 'Reims', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Saint-Étienne 1', city: 'Saint-Étienne', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Saint-Étienne 2', city: 'Saint-Étienne', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Le Havre 1', city: 'Le Havre', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Le Havre 2', city: 'Le Havre', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Toulon 1', city: 'Toulon', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Toulon 2', city: 'Toulon', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Grenoble 1', city: 'Grenoble', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Grenoble 2', city: 'Grenoble', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Dijon 1', city: 'Dijon', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Dijon 2', city: 'Dijon', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Angers 1', city: 'Angers', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Angers 2', city: 'Angers', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Villeurbanne 1', city: 'Villeurbanne', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Villeurbanne 2', city: 'Villeurbanne', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Saint-Denis 1', city: 'Saint-Denis', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Saint-Denis 2', city: 'Saint-Denis', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Le Mans 1', city: 'Le Mans', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Le Mans 2', city: 'Le Mans', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Aix-en-Provence 1', city: 'Aix-en-Provence', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Aix-en-Provence 2', city: 'Aix-en-Provence', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Brest 1', city: 'Brest', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Brest 2', city: 'Brest', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Perpignan 1', city: 'Perpignan', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Perpignan 2', city: 'Perpignan', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Metz 1', city: 'Metz', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Metz 2', city: 'Metz', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Besançon 1', city: 'Besançon', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Besançon 2', city: 'Besançon', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Orléans 1', city: 'Orléans', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Orléans 2', city: 'Orléans', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Rouen 1', city: 'Rouen', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Rouen 2', city: 'Rouen', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Mulhouse 1', city: 'Mulhouse', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Mulhouse 2', city: 'Mulhouse', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Caen 1', city: 'Caen', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Caen 2', city: 'Caen', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Nancy 1', city: 'Nancy', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Nancy 2', city: 'Nancy', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Tourcoing 1', city: 'Tourcoing', type: 'Musculation', payant: true },
  { name: 'Salle de Musculation Tourcoing 2', city: 'Tourcoing', type: 'Musculation', payant: true },
];
...
// ---------- DEMANDES D'AMI PAR PSEUDO (Firestore réel) ----------
async function searchUserByPseudo(pseudo, excludeUid) {
  try {
    const target = (pseudo || '').trim().toLowerCase().replace(/^@/, '');
    if (!target) return null;
    const snap = await db.collection('users').where('pseudoLower', '==', target).limit(1).get();
    if (snap.empty) return null;
    const doc = snap.docs[0];
    if (doc.id === excludeUid) return null;
...
async function sendFriendRequestByPseudo(fromUser, toUser) {
  try {
    const existing = await db.collection('friendRequests')
      ...
      .limit(1)
      .get();
    if (!existing.empty) return { ok: true, alreadySent: true };
...
async function getIncomingFriendRequests(uid) {
  try {
...
async function getAcceptedSentRequests(uid) {
  try {
    const snap = await db.collection('friendRequests')
      .where('fromUid', '==', uid)
      .where('status', '==', 'accepted')
      .where('acknowledgedBySender', '==', false)
      .get();
    return snap.docs.map((doc) => ({ id: doc.id, ...doc.data() }));
  } catch (e) {
    return [];
...
async function respondToFriendRequestByPseudo(requestId, accept) {
  try {
...
async function acknowledgeFriendRequest(requestId) {
  try {
    await db.collection('friendRequests').doc(requestId).update({ acknowledgedBySender: true });
  } catch (e) {}
}

// ---------- SÉANCE EN DIRECT (partage GPS + stats en temps réel avec un ami) ----------
// ⚠️ Pas un vrai flux vidéo/audio continu : les stats se mettent à jour toutes les
// quelques secondes via Firestore, et le "talkie-walkie" envoie de courts messages
// vocaux (quelques secondes), pas un appel audio en continu.

async function createLiveSession(hostUid, hostPseudo, viewerUid, viewerPseudo, sport) {
  try {
    const ref = await db.collection('liveSessions').add({
      hostUid,
      hostPseudo,
      viewerUid,
      viewerPseudo,
...
async function updateLiveSession(sessionId, data) {
  if (!sessionId) return;
  try {
    await db.collection('liveSessions').doc(sessionId).update({ ...data, lastUpdate: new Date().toISOString() });
  } catch (e) {}
}
...
async function endLiveSession(sessionId) {
  if (!sessionId) return;
  try {
    await db.collection('liveSessions').doc(sessionId).update({ active: false });
  } catch (e) {}
}

function subscribeLiveSession(sessionId, callback) {
  return db.collection('liveSessions').doc(sessionId).onSnapshot((doc) => {
    if (doc.exists) callback({ id: doc.id, ...doc.data() });
  });
}

async function getActiveLiveSessionsForViewer(uid) {
  try {
...
// Message vocal court (talkie-walkie) : encodé en base64 et stocké directement dans le
// document de la séance (pas de vrai stockage fichier configuré) — à garder très court.
async function sendVoiceMessage(sessionId, fromUid, audioBase64) {
  if (!sessionId) return;
  try {
    await db.collection('liveSessions').doc(sessionId).update({
      lastVoiceMessage: { from: fromUid, audioBase64, sentAt: new Date().toISOString() },
    });
  } catch (e) {}
}
...
async function deleteMessageFromConversation(requestId, messageId) {
  try {
    const convs = await getMatchConversations();
    if (!convs[requestId]) return;
    convs[requestId] = convs[requestId].filter(m => m.id !== messageId);
    await AsyncStorage.setItem(MATCH_CONVERSATIONS_KEY, JSON.stringify(convs));
  } catch (e) {}
}
...
// Emplacement publicitaire — visible uniquement pour les comptes gratuits, masqué en Premium.
// ⚠️ Ceci est un emplacement visuel prêt à recevoir de vraies publicités : aucun réseau
// publicitaire n'est branché à ce jour (il faudra intégrer Google AdMob ou équivalent, avec
// un vrai compte annonceur, pour que des publicités réelles s'affichent et génèrent un revenu).
function AdBanner({ isPremium }) {
  if (isPremium) return null;
  return (
    <TouchableOpacity
      activeOpacity={0.8}
      style={{ marginHorizontal: 16, marginBottom: 16, backgroundColor: C.card, borderRadius: 16, borderWidth: 1, borderColor: C.border, padding: 14, flexDirection: 'row', alignItems: 'center' }}
    >
      <View style={{ width: 44, height: 44, borderRadius: 12, backgroundColor: C.chip, alignItems: 'center', justifyContent: 'center', marginRight: 12 }}>
        <Ionicons name="megaphone-outline" size={20} color={C.primary} />
      </View>
      <View style={{ flex: 1 }}>
        <Text style={{ fontSize: 9, fontWeight: '800', color: C.light, letterSpacing: 0.5 }}>PUBLICITÉ</Text>
        <Text style={{ fontSize: 13, fontWeight: '700', color: C.dark, marginTop: 2 }}>Emplacement publicitaire</Text>
      </View>
      <View style={{ backgroundColor: C.chip, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 999 }}>
        <Text style={{ fontSize: 10, fontWeight: '800', color: C.primary }}>SANS PUB EN PREMIUM</Text>
      </View>
    </TouchableOpacity>
  );
}
...
function HomeScreen({ go, goBack, authUser }) {
  ...
  const [subStatus, setSubStatus] = useState({ isPremium: false });
  ...
  useEffect(() => {
    (async () => {
      ...
      setSubStatus(sub);
      if (authUser?.uid) {
        setLiveSessions(await getActiveLiveSessionsForViewer(authUser.uid));
      }
    })();
  }, []);
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      {liveSessions.length > 0 ? (
        <View style={{ marginHorizontal: 16, marginBottom: 16 }}>
          {liveSessions.map((sess) => (
            <TouchableOpacity
              key={sess.id}
              onPress={() => go('liveWatch', { sessionId: sess.id })}
              style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(239,68,68,0.12)', borderRadius: 16, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: '#EF4444' }}
            >
              <View style={{ width: 10, height: 10, borderRadius: 5, backgroundColor: '#EF4444', marginRight: 10 }} />
              <Text style={{ flex: 1, fontWeight: '700', fontSize: 13, color: C.dark }}>🔴 {sess.hostPseudo} est en direct — regarder</Text>
      ...
      <AdBanner isPremium={subStatus.isPremium} />
          ...
          <View style={s.suggestionsBox}>
            {stadiumSuggestions.map((st) => (
              <TouchableOpacity key={`${st.name}-${st.city}`} style={s.suggestionRow} onPress={() => pickStadium(st)}>
                <Ionicons name={
                  st.type === 'Piscine' ? 'water-outline' :
                  st.type === 'Équitation' ? 'horse-outline' :
                  st.type === 'Golf' ? 'golf-outline' :
                  st.type === 'Escalade' ? 'trending-up-outline' :
                  st.type === 'Skate / Roller' ? 'skateboarding-outline' :
                  st.type === 'Tennis' ? 'tennisball-outline' :
                  st.type === 'Arts martiaux' ? 'fitness-outline' :
                  st.type === 'Salle de sport' ? 'barbell-outline' :
                  st.type === 'Musculation' ? 'barbell-outline' :
                  st.type === 'Hippisme' ? 'horse-outline' :
                  st.type === 'Badminton' ? 'tennisball-outline' :
                  st.type === 'Volleyball' ? 'basketball-outline' :
                  st.type === 'Handball' ? 'hand-left-outline' :
                  st.type === 'Rugby' ? 'american-football-outline' :
                  st.type === 'Basketball' ? 'basketball-outline' :
                  st.type === 'Cyclisme' ? 'bicycle-outline' :
                  st.type === 'Athlétisme' ? 'walk-outline' :
                  st.type === 'City stade' ? 'football-outline' :
                  st.type === 'Multisports' ? 'football-outline' :
                  'football-outline'
        ...
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'flex-end' }}>
          <View style={{ backgroundColor: C.card, borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, paddingBottom: 40 }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'baseline', gap: 4, marginBottom: 8 }}>
              <Text style={{ fontSize: 36, fontWeight: '900', color: C.primary }}>{PREMIUM_PRICE}</Text>
            </View>
...
function TrackScreen({ go, goBack, authUser }) {
  const [detectedSport, setDetectedSport] = useState('marche');
  const [heading, setHeading] = useState(null);
  const headingRef = useRef(null);

  // Détection automatique du sport selon la vitesse instantanée
  const detectSportFromSpeed = (speedKmh) => {
    if (speedKmh > 8) return 'course';
    if (speedKmh < 4) return 'randonnee';
    return 'marche';
  };

  // Détection finale basée sur la vitesse moyenne de la séance
  const detectFinalSport = (avgSpeedKmh) => {
    if (avgSpeedKmh > 8) return 'course';
    if (avgSpeedKmh < 4) return 'randonnee';
    return 'marche';
  };

  const getSportLabelLive = (sportKey) => {
    const map = { course: 'Course à pied', marche: 'Marche', randonnee: 'Randonnée' };
  ...
  const [showGoalTab, setShowGoalTab] = useState(false);
  const [goalMinutes, setGoalMinutes] = useState(null); // objectif de durée (minutes), null = aucun
  ...
  const [sharingWithPseudo, setSharingWithPseudo] = useState(null);
  const recordingRef = useRef(null);
  const [isRecordingVoice, setIsRecordingVoice] = useState(false);
  const hostSoundRef = useRef(null);
  const lastIncomingVoiceTsRef = useRef(null);

  useEffect(() => {
    return () => {
      if (liveShareIntervalRef.current) clearInterval(liveShareIntervalRef.current);
      if (liveSessionIdRef.current) endLiveSession(liveSessionIdRef.current);
    };
  }, []);

  // Écoute les messages vocaux envoyés en retour par l'ami qui regarde le direct
  useEffect(() => {
    if (!liveSessionId) return;
    const unsubscribe = subscribeLiveSession(liveSessionId, async (data) => {
      const vm = data.lastVoiceMessage;
      if (!vm || vm.from === authUser?.uid) return;
      if (lastIncomingVoiceTsRef.current === vm.sentAt) return;
      lastIncomingVoiceTsRef.current = vm.sentAt;
      try {
        const fileUri = FileSystem.cacheDirectory + 'voice_host_' + Date.now() + '.m4a';
        await FileSystem.writeAsStringAsync(fileUri, vm.audioBase64, { encoding: FileSystem.EncodingType.Base64 });
        const { sound } = await Audio.Sound.createAsync({ uri: fileUri });
        hostSoundRef.current = sound;
  ...
  const pedometerPollRef = useRef(null);
  ...
  // Charge le dernier objectif de durée utilisé, pour ne pas avoir à le retaper à chaque séance
  useEffect(() => {
    (async () => {
      try {
        const saved = await AsyncStorage.getItem('run_goal_minutes');
        if (saved) setGoalMinutes(parseInt(saved, 10));
      } catch (e) {}
    })();
  }, []);

  const setGoal = async (minutes) => {
    setGoalMinutes(minutes);
    setGoalReachedNotified(false);
    try {
      if (minutes) await AsyncStorage.setItem('run_goal_minutes', String(minutes));
      else await AsyncStorage.removeItem('run_goal_minutes');
    } catch (e) {}
  };
  ...
  // --- PODOMÈTRE NATIF ---
  // Fallback : estimation GPS quand le capteur natif ne répond pas
  const estimateStepsFromDistance = (distanceKm) => {
    const stride = detectedSport === 'course' || detectedSport === 'trail' ? 1200 : 1350;
    return Math.round(distanceKm * stride);
  };
  ...
  const startPedometer = async () => {
    ...
    if (Platform.OS === 'android') {
      try {
        const granted = await PermissionsAndroid.request(
          ...
          {
            title: 'Accès au podomètre',
            message: "L'application a besoin d'accéder au capteur de pas pour compter vos pas pendant la séance.",
        ...
        console.warn('Erreur permission ACTIVITY_RECOGNITION:', e);
      }
    }
    ...
    try {
      ...
      baseline = result && typeof result.steps === 'number' ? result.steps : 0;
    } catch (e) {
      baseline = 0;
    }

    setStepCountStart(baseline);
    stepCountStartRef.current = baseline;
    setPedometerStatus('active');

    try {
      pedometerSubRef.current = Pedometer.watchStepCount((result) => {
        const currentTotal = result && typeof result.steps === 'number' ? result.steps : 0;
        const sessionSteps = Math.max(0, currentTotal - (stepCountStartRef.current || 0));
        setSteps(sessionSteps);
      });
    } catch (e) {
      console.warn('watchStepCount erreur:', e);
    }

    // Fallback polling toutes les 3s (essentiel sur Android)
    if (pedometerPollRef.current) clearInterval(pedometerPollRef.current);
    pedometerPollRef.current = setInterval(async () => {
      try {
        const end = new Date();
        const start = new Date();
        start.setHours(0, 0, 0, 0);
        ...
        const currentTotal = result && typeof result.steps === 'number' ? result.steps : 0;
        const sessionSteps = Math.max(0, currentTotal - (stepCountStartRef.current || 0));
        setSteps((prev) => Math.max(prev, sessionSteps));
      } catch (e) {}
    }, 3000);
  };
  ...
  const stopPedometer = () => {
    if (pedometerSubRef.current) {
      try { pedometerSubRef.current.remove(); } catch (e) {}
      pedometerSubRef.current = null;
    }
    if (pedometerPollRef.current) {
      clearInterval(pedometerPollRef.current);
      pedometerPollRef.current = null;
    }
  };
  ...
  // Cleanup podomètre au démontage de l'écran
  useEffect(() => {
  ...
  const start = async () => {
    ...
    if (!paused) { lastCoordRef.current = null; speedBufferRef.current = []; setPathCoords([]); setGoalReachedNotified(false); }
    ...
    try {
      watchRef.current = await Location.watchPositionAsync(
        ...
        (loc) => {
          ...
          setDetectedSport(detectSportFromSpeed(smoothedKmh));
  ...
  const startSharingWith = async (friend) => {
    ...
    if (!sessionId) {
      alert("Impossible de démarrer le direct — vérifie ta connexion.");
      return;
    }
    liveSessionIdRef.current = sessionId;
    setLiveSessionId(sessionId);
    setSharingWithPseudo(friend.pseudo || friend.name);
    // Pousse les stats en direct toutes les 5 secondes
    liveShareIntervalRef.current = setInterval(() => {
      updateLiveSession(liveSessionIdRef.current, {
        distanceKm: kmRef.current,
        seconds: secondsRef.current,
        isPaused: !!currentPauseStart,
        pauseSeconds: totalPauseSeconds,
        path: pathCoords.slice(-150),
      });
    }, 5000);
  };

  const stopSharing = () => {
    if (liveShareIntervalRef.current) { clearInterval(liveShareIntervalRef.current); liveShareIntervalRef.current = null; }
    if (liveSessionIdRef.current) { endLiveSession(liveSessionIdRef.current); }
    liveSessionIdRef.current = null;
    setLiveSessionId(null);
    setSharingWithPseudo(null);
  };

  // Talkie-walkie : enregistre un court message vocal et l'envoie dès le relâchement du bouton
  ...
  const stopVoiceRecordingAndSend = async () => {
    ...
    try {
      ...
      if (!uri || !liveSessionIdRef.current || !authUser?.uid) return;
      const base64 = await FileSystem.readAsStringAsync(uri, { encoding: FileSystem.EncodingType.Base64 });
      await sendVoiceMessage(liveSessionIdRef.current, authUser.uid, base64);
    } catch (e) {}
  };

  const stop = async () => {
    if (liveShareIntervalRef.current) { clearInterval(liveShareIntervalRef.current); liveShareIntervalRef.current = null; }
    if (liveSessionIdRef.current) { endLiveSession(liveSessionIdRef.current); liveSessionIdRef.current = null; setLiveSessionId(null); setSharingWithPseudo(null); }
    if (timerRef.current) clearInterval(timerRef.current);
    if (watchRef.current) { watchRef.current.remove(); watchRef.current = null; }
    stopPedometer();
    setRunning(false);
    ...
    const cals = Math.round(km * (detectedSport === 'course' ? 60 : detectedSport === 'marche' ? 40 : 50));
    ...
    // Détection finale du sport
    const avgSpeedKmh = secondsRef.current > 0 ? (km / (secondsRef.current / 3600)) : 0;
    const finalSport = detectFinalSport(avgSpeedKmh);
  ...
  const calories = Math.round(km * (detectedSport === 'course' ? 60 : detectedSport === 'marche' ? 40 : 50));
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#0B0B14' }}>
      ...
      {/* ONGLETS SÉANCE / OBJECTIF */}
      <View style={{ flexDirection: 'row', paddingHorizontal: 16, marginTop: 10, gap: 8 }}>
        <TouchableOpacity
          onPress={() => setShowGoalTab(false)}
          style={{ flex: 1, alignItems: 'center', paddingVertical: 10, borderRadius: 12, backgroundColor: !showGoalTab ? C.primary : 'rgba(255,255,255,0.06)' }}
        >
          <Text style={{ fontWeight: '800', fontSize: 12, color: !showGoalTab ? '#fff' : 'rgba(255,255,255,0.5)' }}>🏃 SÉANCE</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => setShowGoalTab(true)}
          style={{ flex: 1, alignItems: 'center', paddingVertical: 10, borderRadius: 12, backgroundColor: showGoalTab ? C.primary : 'rgba(255,255,255,0.06)' }}
        >
          <Text style={{ fontWeight: '800', fontSize: 12, color: showGoalTab ? '#fff' : 'rgba(255,255,255,0.5)' }}>
            🎯 OBJECTIF{goalMinutes ? ` (${goalMinutes} min)` : ''}
          </Text>
        </TouchableOpacity>
      </View>

      {showGoalTab ? (
        /* PANNEAU DE RÉGLAGE DE L'OBJECTIF DE DURÉE */
        <View style={{ marginHorizontal: 16, marginTop: 14, backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: 16, padding: 16 }}>
          <Text style={{ color: '#fff', fontWeight: '800', fontSize: 14, marginBottom: 4 }}>Durée cible de la séance</Text>
          <Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 12, marginBottom: 14, lineHeight: 17 }}>
            Fixe un temps à atteindre — ta progression s'affichera pendant la séance.
          </Text>
            ...
            {[10, 15, 20, 30, 45, 60].map((min) => (
              <TouchableOpacity
                ...
                style={{
                  ...
                  paddingVertical: 10,
                  borderRadius: 999,
                  backgroundColor: goalMinutes === min ? C.primary : 'rgba(255,255,255,0.06)',
                  borderWidth: goalMinutes === min ? 0 : 1,
                  borderColor: 'rgba(255,255,255,0.15)',
                }}
              >
                <Text style={{ color: goalMinutes === min ? '#fff' : 'rgba(255,255,255,0.7)', fontWeight: '700', fontSize: 13 }}>{min} min</Text>
              </TouchableOpacity>
            ))}
          </View>

          <Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 11, fontWeight: '700', marginBottom: 6 }}>OU UNE DURÉE PERSONNALISÉE (MIN)</Text>
          <View style={{ flexDirection: 'row', gap: 8 }}>
            <TextInput
              style={{ flex: 1, backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, paddingHorizontal: 14, paddingVertical: 10, color: '#fff', fontSize: 14 }}
              placeholder="Ex: 25"
            ...
            />
            <TouchableOpacity
              onPress={() => { const v = parseInt(goalInput, 10); if (v > 0) { setGoal(v); setGoalInput(''); } }}
              style={{ backgroundColor: C.primary, borderRadius: 12, paddingHorizontal: 18, alignItems: 'center', justifyContent: 'center' }}
            >
              <Text style={{ color: '#fff', fontWeight: '800', fontSize: 13 }}>OK</Text>
            </TouchableOpacity>
          </View>

          {goalMinutes ? (
            <TouchableOpacity onPress={() => setGoal(null)} style={{ marginTop: 16, alignItems: 'center' }}>
              <Text style={{ color: '#F87171', fontWeight: '700', fontSize: 12 }}>Retirer l'objectif</Text>
            </TouchableOpacity>
          ) : null}
        </View>
      ) : null}
...
{/* COMPTEURS PRINCIPAUX */}
      ...
      {/* PROGRESSION VERS L'OBJECTIF DE DURÉE */}
      {goalMinutes ? (
        <View style={{ marginHorizontal: 16, marginTop: 10 }}>
          {seconds >= goalMinutes * 60 ? (
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: 'rgba(34,197,94,0.15)', borderRadius: 999, paddingVertical: 8, borderWidth: 1, borderColor: '#22C55E' }}>
              <Ionicons name="checkmark-circle" size={16} color="#22C55E" />
              <Text style={{ color: '#22C55E', fontWeight: '800', fontSize: 12 }}>🎯 Objectif de {goalMinutes} min atteint !</Text>
            </View>
          ) : (
            <>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 6 }}>
                <Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 11, fontWeight: '700' }}>🎯 OBJECTIF {goalMinutes} MIN</Text>
                <Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 11, fontWeight: '700' }}>
                  {Math.max(0, Math.ceil((goalMinutes * 60 - seconds) / 60))} min restantes
                </Text>
              </View>
              <View style={{ height: 8, borderRadius: 999, backgroundColor: 'rgba(255,255,255,0.1)', overflow: 'hidden' }}>
                <View style={{
                  height: '100%',
                  width: `${Math.min(100, (seconds / (goalMinutes * 60)) * 100)}%`,
                  borderRadius: 999,
                  backgroundColor: C.primary,
                }} />
              </View>
        ...
        <View style={{ flexDirection: 'row', gap: 8 }}>
          ...
          <View style={{ flex: 1, backgroundColor: 'rgba(59,130,246,0.1)', borderRadius: 12, padding: 10, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(59,130,246,0.3)' }}>
            ...
            <Text style={{ color: '#fff', fontSize: 18, fontWeight: '800', marginTop: 2 }}>
              {steps > 0 ? steps : (km > 0.05 ? estimateStepsFromDistance(km) : '—')}
            </Text>
            {pedometerStatus !== 'active' && km > 0.05 && (
              <Text style={{ color: 'rgba(255,255,255,0.35)', fontSize: 8, marginTop: 2 }}>estimé</Text>
            )}
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 10, paddingBottom: 16, backgroundColor: '#0B0B14', zIndex: 10, elevation: 10 }}>
        {(running || paused) ? (
          liveSessionId ? (
            <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(239,68,68,0.15)', borderRadius: 14, padding: 10, marginBottom: 10, borderWidth: 1, borderColor: '#EF4444' }}>
              <View style={{ width: 8, height: 8, borderRadius: 4, backgroundColor: '#EF4444', marginRight: 8 }} />
              <Text style={{ color: '#fff', fontWeight: '700', fontSize: 12, flex: 1 }}>🔴 En direct avec {sharingWithPseudo}</Text>
              <TouchableOpacity
                onPressIn={startVoiceRecording}
                onPressOut={stopVoiceRecordingAndSend}
                style={{ backgroundColor: isRecordingVoice ? '#EF4444' : 'rgba(255,255,255,0.15)', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8, marginRight: 8 }}
              >
            ...
            <TouchableOpacity onPress={openShareModal} style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 14, padding: 10, marginBottom: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.15)' }}>
              <Ionicons name="radio-outline" size={16} color="#fff" />
              <Text style={{ color: '#fff', fontWeight: '700', fontSize: 12, marginLeft: 6 }}>📡 Partager en direct avec un ami</Text>
            </TouchableOpacity>
          )
        ) : null}
      ...
      {/* MODALE — CHOIX DE L'AMI POUR LE DIRECT */}
      <Modal visible={showShareModal} transparent animationType="slide" onRequestClose={() => setShowShareModal(false)}>
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', justifyContent: 'flex-end' }}>
          <View style={{ backgroundColor: '#151521', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 20, maxHeight: '70%' }}>
            <Text style={{ color: '#fff', fontWeight: '800', fontSize: 16, marginBottom: 4 }}>Partager cette séance en direct</Text>
            <Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 12, marginBottom: 16 }}>
              Ton ami verra ta distance, ton temps et tes pauses se mettre à jour en direct, avec ton trajet GPS.
            </Text>
            {shareFriends.length === 0 ? (
              <Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 13 }}>Tu n'as pas encore d'amis à qui partager. Ajoute-en depuis Contacts.</Text>
            ) : (
              <ScrollView>
                {shareFriends.map((f) => (
                  <TouchableOpacity
                    key={f.id}
                    onPress={() => startSharingWith(f)}
                    style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 14, padding: 14, marginBottom: 8 }}
                  >
                    <Text style={{ fontSize: 18, marginRight: 10 }}>{f.emoji || '🏃'}</Text>
                    <Text style={{ color: '#fff', fontWeight: '700', fontSize: 14, flex: 1 }}>{f.pseudo || f.name}</Text>
                    <Ionicons name="radio-outline" size={18} color={C.primary} />
                  </TouchableOpacity>
                ))}
              </ScrollView>
            )}
            <TouchableOpacity onPress={() => setShowShareModal(false)} style={{ marginTop: 12, alignItems: 'center', paddingVertical: 10 }}>
              <Text style={{ color: 'rgba(255,255,255,0.5)', fontWeight: '700' }}>Annuler</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
            ...
            {history.map((entry) => (
              ...
              >
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 10 }}>
                  ...
                  {entry.maxSpeedKmh ? (
                    <View style={{ backgroundColor: C.chip, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 8, alignItems: 'center' }}>
                      <Text style={{ fontSize: 16, fontWeight: '800', color: C.primary }}>{entry.maxSpeedKmh}</Text>
                      <Text style={{ fontSize: 9, color: C.gray, fontWeight: '700' }}>VMAX KM/H</Text>
                    </View>
                  ) : null}
                  {entry.reps ? (
                    <View style={{ backgroundColor: C.chip, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 8, alignItems: 'center' }}>
...
// ---------- ÉCRAN "REGARDER EN DIRECT" (vue de l'ami qui suit la séance) ----------
// Dessine un tracé GPS léger fait maison (positions normalisées dans une boîte), sans
// dépendance à une librairie de cartes — pour éviter d'ajouter un nouveau module natif lourd.
function LivePathPreview({ path }) {
  if (!path || path.length < 2) {
    return (
      <View style={{ height: 180, borderRadius: 16, backgroundColor: 'rgba(255,255,255,0.05)', alignItems: 'center', justifyContent: 'center' }}>
        <Text style={{ color: 'rgba(255,255,255,0.4)', fontSize: 12 }}>En attente du trajet GPS...</Text>
      </View>
    );
  }
  const lats = path.map((p) => p.latitude ?? p.lat);
  const lons = path.map((p) => p.longitude ?? p.lon);
  const minLat = Math.min(...lats), maxLat = Math.max(...lats);
  const minLon = Math.min(...lons), maxLon = Math.max(...lons);
  const spanLat = Math.max(maxLat - minLat, 0.0001);
  const spanLon = Math.max(maxLon - minLon, 0.0001);
  return (
    <View style={{ height: 180, borderRadius: 16, backgroundColor: 'rgba(255,255,255,0.05)', overflow: 'hidden' }}>
      {path.map((p, i) => {
        const lat = p.latitude ?? p.lat;
        const lon = p.longitude ?? p.lon;
        const x = ((lon - minLon) / spanLon) * 88 + 6;
        const y = (1 - (lat - minLat) / spanLat) * 88 + 6;
        ...
        return (
          <View
            ...
            style={{
              ...
              height: isLast ? 12 : 4,
              borderRadius: 6,
              backgroundColor: isLast ? '#EF4444' : C.primary,
            }}
          />
        );
      })}
...
function LiveWatchScreen({ goBack, params, authUser }) {
  ...
  useEffect(() => {
    if (!sessionId) return;
    const unsubscribe = subscribeLiveSession(sessionId, (data) => setSession(data));
    return () => unsubscribe && unsubscribe();
  }, [sessionId]);

  // Joue automatiquement chaque nouveau message vocal reçu (talkie-walkie)
  useEffect(() => {
    (async () => {
      const vm = session?.lastVoiceMessage;
      if (!vm || vm.from === authUser?.uid) return;
      if (lastVoiceTsRef.current === vm.sentAt) return;
      lastVoiceTsRef.current = vm.sentAt;
      try {
        const fileUri = FileSystem.cacheDirectory + 'voice_' + Date.now() + '.m4a';
        await FileSystem.writeAsStringAsync(fileUri, vm.audioBase64, { encoding: FileSystem.EncodingType.Base64 });
        const { sound } = await Audio.Sound.createAsync({ uri: fileUri });
  ...
  const stopVoiceRecordingAndSend = async () => {
    ...
    try {
      ...
      const uri = recording.getURI();
      recordingRef.current = null;
      if (!uri || !sessionId || !authUser?.uid) return;
      const base64 = await FileSystem.readAsStringAsync(uri, { encoding: FileSystem.EncodingType.Base64 });
      await sendVoiceMessage(sessionId, authUser.uid, base64);
    } catch (e) {}
  };

  if (!session) {
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: '#0B0B14', alignItems: 'center', justifyContent: 'center' }}>
        <ActivityIndicator color={C.primary} size="large" />
        <Text style={{ color: '#fff', marginTop: 16 }}>Connexion au direct...</Text>
      </SafeAreaView>
    );
  }

  const mm = Math.floor((session.seconds || 0) / 60).toString().padStart(2, '0');
  const ss = ((session.seconds || 0) % 60).toString().padStart(2, '0');
  const pauseMin = Math.floor((session.pauseSeconds || 0) / 60);

  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#0B0B14' }}>
      <Header title={`🔴 Direct — ${session.hostPseudo}`} onBack={goBack} dark />
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        {!session.active ? (
          <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 14, padding: 14, marginBottom: 16 }}>
            <Text style={{ color: '#fff', fontWeight: '700', textAlign: 'center' }}>La séance est terminée</Text>
          </View>
        ) : session.isPaused ? (
          <View style={{ backgroundColor: 'rgba(234,179,8,0.15)', borderRadius: 14, padding: 14, marginBottom: 16, borderWidth: 1, borderColor: '#EAB308' }}>
            <Text style={{ color: '#EAB308', fontWeight: '700', textAlign: 'center' }}>🟡 {session.hostPseudo} est en pause</Text>
          </View>
        ) : null}

        <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginBottom: 16 }}>
          <View style={{ alignItems: 'center' }}>
            <Text style={{ color: '#fff', fontSize: 32, fontWeight: '900' }}>{(session.distanceKm || 0).toFixed(2)}</Text>
            <Text style={{ color: 'rgba(255,255,255,0.5)', fontWeight: '700', fontSize: 11 }}>KM</Text>
          </View>
          <View style={{ alignItems: 'center' }}>
            <Text style={{ color: '#fff', fontSize: 32, fontWeight: '900' }}>{mm}:{ss}</Text>
            <Text style={{ color: 'rgba(255,255,255,0.5)', fontWeight: '700', fontSize: 11 }}>DURÉE</Text>
          </View>
          <View style={{ alignItems: 'center' }}>
            <Text style={{ color: '#fff', fontSize: 32, fontWeight: '900' }}>{pauseMin}</Text>
            <Text style={{ color: 'rgba(255,255,255,0.5)', fontWeight: '700', fontSize: 11 }}>MIN PAUSE</Text>
          </View>
        </View>

        <Text style={{ color: 'rgba(255,255,255,0.5)', fontWeight: '700', fontSize: 11, marginBottom: 8 }}>TRAJET GPS (aperçu simplifié)</Text>
        <LivePathPreview path={session.path} />
        ...
        {session.active ? (
          <TouchableOpacity
            ...
            style={{
              ...
              backgroundColor: isRecordingVoice ? '#EF4444' : C.primary,
              borderRadius: 999, paddingVertical: 16, marginTop: 24,
            }}
          >
            <Ionicons name="mic" size={20} color="#fff" />
            <Text style={{ color: '#fff', fontWeight: '800', fontSize: 14, marginLeft: 8 }}>
              {isRecordingVoice ? 'Relâche pour envoyer...' : 'Maintenir pour parler'}
            </Text>
          </TouchableOpacity>
        ) : null}
      </ScrollView>
...
function ContactsScreen({ go, goBack, authUser }) {
  const [pseudoInput, setPseudoInput] = useState('');
  ...
  const loadAll = async () => {
    ...
    if (authUser?.uid) {
      const [incoming, acceptedSent] = await Promise.all([
        getIncomingFriendRequests(authUser.uid),
        getAcceptedSentRequests(authUser.uid),
      ]);
      setIncomingRequests(incoming);
      for (const req of acceptedSent) {
        await addFriend({ id: req.toUid, name: req.toPseudo, pseudo: req.toPseudo, emoji: '🏃' });
        await acknowledgeFriendRequest(req.id);
      }
      if (acceptedSent.length > 0) setFriends(await getFriendsList());
    }
  };

  const handleSearch = async () => {
    if (!pseudoInput.trim() || !authUser?.uid) return;
    setSearching(true);
    setSearchResult(null);
    setSendState(null);
    const result = await searchUserByPseudo(pseudoInput, authUser.uid);
    setSearchResult(result || 'not_found');
    setSearching(false);
  };

  const handleSendRequest = async () => {
    if (!searchResult || searchResult === 'not_found' || !authUser?.uid) return;
    setSendState('sending');
    const me = { uid: authUser.uid, pseudo: authUser.pseudo || '@moi', emoji: '🏃' };
    const res = await sendFriendRequestByPseudo(me, searchResult);
    setSendState(res.ok ? (res.alreadySent ? 'already_sent' : 'sent') : null);
  };

  const handleRespond = async (request, accept) => {
    await respondToFriendRequestByPseudo(request.id, accept);
    if (accept) {
      const updated = await addFriend({ id: request.fromUid, name: request.fromPseudo, pseudo: request.fromPseudo, emoji: request.fromEmoji || '🏃' });
      setFriends(updated);
    }
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        <Text style={[s.subLabel, { marginBottom: 8 }]}>AJOUTER PAR PSEUDO</Text>
        <View style={{ flexDirection: 'row', gap: 8, marginBottom: 8 }}>
          <TextInput
            style={[s.input, { flex: 1 }]}
            placeholder="@pseudo (celui de l'inscription)"
            placeholderTextColor={C.light}
            autoCapitalize="none"
            value={pseudoInput}
            onChangeText={(v) => { setPseudoInput(v); setSearchResult(null); setSendState(null); }}
            onSubmitEditing={handleSearch}
          />
          <TouchableOpacity
            onPress={handleSearch}
            disabled={!pseudoInput.trim() || searching}
            style={{ backgroundColor: C.primary, borderRadius: 14, paddingHorizontal: 18, alignItems: 'center', justifyContent: 'center', opacity: !pseudoInput.trim() || searching ? 0.5 : 1 }}
          >
        ...
        {searchResult === 'not_found' ? (
          <Text style={{ color: C.gray, fontSize: 12, marginBottom: 16 }}>Aucun utilisateur avec ce pseudo.</Text>
        ) : searchResult ? (
          <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: C.card, borderRadius: 14, padding: 14, marginBottom: 16, borderWidth: 1, borderColor: C.border }}>
            <View style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: C.chip, alignItems: 'center', justifyContent: 'center' }}>
              <Text style={{ fontSize: 18 }}>🏃</Text>
            </View>
            <Text style={{ flex: 1, marginLeft: 10, fontWeight: '700', fontSize: 14, color: C.dark }}>{searchResult.pseudo}</Text>
            {sendState === 'sent' ? (
              <Text style={{ color: '#22C55E', fontWeight: '700', fontSize: 12 }}>✓ Envoyée</Text>
            ) : sendState === 'already_sent' ? (
              <Text style={{ color: C.gray, fontWeight: '700', fontSize: 12 }}>Déjà envoyée</Text>
            ) : (
              <TouchableOpacity
                onPress={handleSendRequest}
                disabled={sendState === 'sending'}
                style={{ backgroundColor: C.primary, borderRadius: 999, paddingHorizontal: 14, paddingVertical: 8 }}
              >
                {sendState === 'sending' ? <ActivityIndicator color="#fff" size="small" /> : <Text style={{ color: '#fff', fontWeight: '700', fontSize: 12 }}>Envoyer</Text>}
              </TouchableOpacity>
            )}
          </View>
        ) : null}
        ...
        {incomingRequests.length > 0 ? (
          <>
            <Text style={[s.subLabel, { marginBottom: 8, marginTop: 8 }]}>DEMANDES REÇUES ({incomingRequests.length})</Text>
            {incomingRequests.map((req) => (
              <View key={req.id} style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: C.card, borderRadius: 14, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: C.border }}>
                <View style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: C.chip, alignItems: 'center', justifyContent: 'center' }}>
                  <Text style={{ fontSize: 18 }}>{req.fromEmoji || '🏃'}</Text>
                </View>
                <Text style={{ flex: 1, marginLeft: 10, fontWeight: '700', fontSize: 14, color: C.dark }}>{req.fromPseudo}</Text>
                <TouchableOpacity onPress={() => handleRespond(req, true)} style={{ marginRight: 8 }}>
                  <Ionicons name="checkmark-circle" size={30} color="#22C55E" />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => handleRespond(req, false)}>
                  <Ionicons name="close-circle" size={30} color={C.danger} />
                </TouchableOpacity>
              </View>
            ))}
          </>
        ...
        <Text style={[s.subLabel, { marginBottom: 8, marginTop: 8 }]}>MES AMIS ({friends.length})</Text>
        {friends.length === 0 ? (
          <EmptyState icon="people-outline" title="Aucun contact" subtitle="Cherche un ami par son pseudo, ou acceptez une proposition de run." cta="VOIR LES ÉVÉNEMENTS" onCta={() => go('match')} />
        ) : (
          friends.map((f) => (
            <View key={f.id} style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: C.card, borderRadius: 14, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: C.border }}>
              <View style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: C.chip, alignItems: 'center', justifyContent: 'center' }}>
                <Text style={{ fontSize: 18 }}>{f.emoji || '🏃'}</Text>
              </View>
              <Text style={{ flex: 1, marginLeft: 10, fontWeight: '700', fontSize: 14, color: C.dark }}>{f.pseudo || f.name}</Text>
            </View>
          ))
        )}
      </ScrollView>
...
function MatchChatScreen({ goBack, params }) {
  ...
  const confirmDeleteMessage = async () => {
    if (!selectedMessage || !request?.id) return;
    await deleteMessageFromConversation(request.id, selectedMessage.id);
    ...
    return (
      ...
      >
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', justifyContent: 'center', alignItems: 'center', padding: 24 }}>
          <View style={{ backgroundColor: C.card, borderRadius: 20, padding: 24, width: '100%', maxWidth: 320, borderWidth: 1, borderColor: C.border }}>
            <Text style={{ color: C.dark, fontSize: 17, fontWeight: '800', textAlign: 'center' }}>Supprimer ce message ?</Text>
            <Text style={{ color: C.gray, fontSize: 13, textAlign: 'center', marginTop: 8 }}>Ce message sera supprimé de ta conversation. Cette action est irréversible.</Text>
            <View style={{ flexDirection: 'row', marginTop: 20, gap: 10 }}>
              <TouchableOpacity
                onPress={() => { setShowDeleteModal(false); setSelectedMessage(null); }}
                style={{ flex: 1, paddingVertical: 12, borderRadius: 12, backgroundColor: C.chip, alignItems: 'center' }}
              >
                <Text style={{ color: C.gray, fontWeight: '700', fontSize: 14 }}>Annuler</Text>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={confirmDeleteMessage}
                style={{ flex: 1, paddingVertical: 12, borderRadius: 12, backgroundColor: '#EF4444', alignItems: 'center' }}
              >
                <Text style={{ color: '#fff', fontWeight: '700', fontSize: 14 }}>Supprimer</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
...
// Décale de façon déterministe la coordonnée d'une infrastructure autour du centre de sa ville
...
function VenuesScreen({ go, goBack }) {
  ...
  const INFRASTRUCTURE_TYPES = ['Tout', ...Array.from(new Set(FRENCH_STADIUMS.map((s) => s.type))).sort()];

  // Liste filtrée par la recherche et par type, avec la distance
  ...
  const typeFilteredList = selectedType === 'Tout'
    ? baseList
    : baseList.filter((st) => st.type === selectedType);

  const withDistance = typeFilteredList.map((st) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <Header title="Trouver une infrastructure" onBack={goBack} />
      <Banner icon="🏢" eyebrow="INFRASTRUCTURES SPORTIVES" title={`${typeFilteredList.length} lieu${typeFilteredList.length > 1 ? 'x' : ''} disponible${typeFilteredList.length > 1 ? 's' : ''}`} />
      <Text style={{ color: C.light, fontSize: 11, paddingHorizontal: 16, marginTop: -8, marginBottom: 12, lineHeight: 15 }}>
        Les distances (~) sont estimées à partir de la ville de l'infrastructure — ouvre l'itinéraire GPS pour la distance exacte jusqu'à l'adresse précise.
      </Text>
        ...
        {INFRASTRUCTURE_TYPES.map((type) => (
          <TouchableOpacity
            ...
            style={{
              ...
              paddingVertical: 8,
              borderRadius: 20,
              backgroundColor: selectedType === type ? C.primary : C.card,
              borderWidth: 1,
              borderColor: selectedType === type ? C.primary : C.border,
            }}
          >
            <Text
              style={{
                fontSize: 12,
                fontWeight: '700',
                color: selectedType === type ? '#fff' : C.gray,
              }}
            >
              {type === 'Tout' ? 'Tout' : type}
            </Text>
      ...
      <View style={{ paddingHorizontal: 16 }}>
        <TextInput
          style={s.input}
          placeholder="Rechercher une infrastructure, une ville..."
          value={query}
          onChangeText={(v) => {
            setQuery(v);
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <EmptyState icon="business-outline" title="Aucune infrastructure trouvé" subtitle="Essaie une autre recherche." />
        }
        renderItem={({ item }) => (
            ...
            <View style={{ flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' }}>
              <View style={{ flex: 1, marginRight: 8 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 4, gap: 6 }}>
                  <View style={{
                    backgroundColor:
                      item.type === 'Football' ? '#22C55E' :
                      item.type === 'Piscine' ? '#3B82F6' :
                      item.type === 'Équitation' ? '#A855F7' :
                      item.type === 'Golf' ? '#10B981' :
                      item.type === 'Escalade' ? '#F97316' :
                      item.type === 'Skate / Roller' ? '#EF4444' :
                      item.type === 'Tennis' ? '#FBBF24' :
                      item.type === 'Arts martiaux' ? '#DC2626' :
                      item.type === 'Salle de sport' ? '#6366F1' :
                      item.type === 'Musculation' ? '#7C3AED' :
                      item.type === 'Hippisme' ? '#8B5CF6' :
                      item.type === 'Badminton' ? '#14B8A6' :
                      item.type === 'Volleyball' ? '#F59E0B' :
                      item.type === 'Handball' ? '#EC4899' :
                      item.type === 'Rugby' ? '#4F46E5' :
                      item.type === 'Basketball' ? '#F97316' :
                      item.type === 'Cyclisme' ? '#06B6D4' :
                      item.type === 'Athlétisme' ? '#84CC16' :
                      item.type === 'City stade' ? '#F472B6' :
                      C.primary,
                    paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6
                  }}>
                    <Text style={{ color: '#fff', fontSize: 10, fontWeight: '700' }}>{item.type.toUpperCase()}</Text>
                  </View>
                  {item.payant ? (
                    <View style={{ backgroundColor: 'rgba(239,68,68,0.15)', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 }}>
                      <Text style={{ color: '#EF4444', fontSize: 10, fontWeight: '700' }}>PAYANT</Text>
                    </View>
                  ) : (
                    <View style={{ backgroundColor: 'rgba(34,197,94,0.15)', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 }}>
                      <Text style={{ color: '#22C55E', fontSize: 10, fontWeight: '700' }}>GRATUIT</Text>
                    </View>
                  )}
                </View>
              </View>
...
// Section titrée + paragraphes, pour composer l'écran Politique de confidentialité sans
// dépendance à un moteur de rendu Markdown.
function PolicySection({ title, children }) {
  return (
    <View style={{ marginBottom: 20 }}>
      <Text style={{ fontWeight: '800', fontSize: 15, color: C.dark, marginBottom: 8 }}>{title}</Text>
      <Text style={{ color: C.gray, fontSize: 13, lineHeight: 20 }}>{children}</Text>
    </View>
  );
}

function PrivacyPolicyScreen({ goBack }) {
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <Header title="Politique de confidentialité" onBack={goBack} />
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        <View style={{ backgroundColor: '#FEF3C7', borderRadius: 14, padding: 14, marginBottom: 20, borderWidth: 1, borderColor: '#F59E0B' }}>
          <Text style={{ color: '#92400E', fontSize: 12, lineHeight: 18 }}>
            ⚠️ Document à finaliser avant publication : les coordonnées de contact de l'éditeur doivent être complétées. Ce texte reflète le fonctionnement actuel de l'application (stockage local) et devra être mis à jour si un serveur est ajouté.
          </Text>
        </View>

        <PolicySection title="1. Où sont stockées vos données aujourd'hui">
          {"L'application ne dispose d'aucun serveur central à ce jour. Toutes vos données (profil, séances sportives, journal nutritionnel, messages, contacts) sont enregistrées exclusivement sur votre téléphone. Nous n'y avons pas accès à distance, et elles sont supprimées si vous désinstallez l'application."}
        </PolicySection>

        <PolicySection title="2. Données que nous collectons">
          {"• Profil : nom, pseudo, âge, ville, sport(s), photo\n• Localisation GPS : uniquement pendant une séance de suivi, pour calculer distance et trajet\n• Capteurs de mouvement : nombre de pas, accéléromètre, lors de l'utilisation des fonctions concernées\n• Photos : si vous ajoutez une photo de profil\n• Données nutritionnelles : repas et aliments enregistrés\n• Contenus créés : messages, événements, séances partagées"}
        </PolicySection>

        <PolicySection title="3. Services tiers utilisés">
          {"Open Food Facts (openfoodfacts.org) : récupère les informations nutritionnelles d'un produit à partir du code-barres scanné.\n\nOpenStreetMap / Nominatim : convertit votre position GPS en nom de rue pendant une séance de suivi. Seules les coordonnées de l'instant sont transmises, sans aucune information vous identifiant."}
        </PolicySection>

        <PolicySection title="4. Permissions demandées">
          {"• Localisation : suivre votre trajet, trouver les terrains proches\n• Caméra : scanner un code-barres, prendre une photo de profil\n• Capteurs de mouvement : compter vos pas\n• Photos : choisir une photo existante\n\nChaque permission n'est utilisée qu'au moment où vous déclenchez la fonction correspondante. Vous pouvez la refuser ou la révoquer à tout moment dans les réglages de votre téléphone."}
        </PolicySection>

        <PolicySection title="5. Partage de vos données">
          {"Nous ne vendons pas vos données et ne les partageons avec aucun tiers à des fins commerciales ou publicitaires. Restant sur votre appareil, elles ne sont accessibles qu'à vous."}
        </PolicySection>

        <PolicySection title="6. Durée de conservation">
          {"Vos données restent sur votre appareil tant que vous ne les supprimez pas individuellement (repas, séances) ou que vous ne désinstallez pas l'application."}
        </PolicySection>

        <PolicySection title="7. Vos droits (RGPD)">
          {"Vous disposez d'un droit d'accès, de rectification, d'effacement, de portabilité et d'opposition sur vos données. Vos données étant stockées localement, vous y avez un accès et un contrôle direct depuis l'application. Pour toute question, contactez-nous à instrumentalbeat27@gmail.com."}
        </PolicySection>

        <PolicySection title="8. Sécurité">
          {"Les données étant stockées localement, leur sécurité dépend en partie de la protection de votre appareil (verrouillage par code, biométrie). Nous vous recommandons de protéger l'accès à votre téléphone."}
        </PolicySection>

        <PolicySection title="9. Mineurs">
          {"L'application n'est pas destinée aux enfants en bas âge. Nous ne collectons pas sciemment de données concernant de jeunes enfants."}
        </PolicySection>

        <PolicySection title="10. Modifications de cette politique">
          {"Cette politique peut être mise à jour, notamment si l'application évolue vers un fonctionnement avec serveur central. Toute modification substantielle vous sera signalée avant son entrée en vigueur."}
        </PolicySection>

        <View style={{ backgroundColor: C.chip, borderRadius: 14, padding: 14, marginTop: 4 }}>
          <Text style={{ color: C.gray, fontSize: 12, lineHeight: 18 }}>
            📧 Contact : instrumentalbeat27@gmail.com{"\n\n"}Vous disposez également du droit d'introduire une réclamation auprès de la CNIL (www.cnil.fr).
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
...
function ProfileScreen({ go, goBack, profilePhoto, setProfilePhoto, logout }) {
  ...
  // Suppression de compte : supprime le profil Firestore et le compte Firebase Auth
  // lui-même (plus seulement les données locales, maintenant que Firebase est branché).
  const confirmDeleteAccount = async () => {
    ...
    try {
      ...
      if (e.code === 'auth/requires-recent-login') {
        alert('Pour ta sécurité, reconnecte-toi puis réessaie de supprimer ton compte immédiatement après.');
        setShowDeleteAccountConfirm(false);
        if (logout) logout();
        return;
      }
      alert("La suppression a échoué. Vérifie ta connexion et réessaie.");
      return;
    }
    setDeletingAccount(false);
    setShowDeleteAccountConfirm(false);
...
<View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          ...
          <View style={{ backgroundColor: subStatus?.isPremium ? 'rgba(34,197,94,0.1)' : C.chip, borderRadius: 12, padding: 12, marginBottom: 12, flexDirection: 'row', alignItems: 'center', gap: 10, borderWidth: 1, borderColor: subStatus?.isPremium ? '#22C55E' : C.border }}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ color: C.gray, fontSize: 11, marginTop: 2 }}>
                {subStatus?.isPremium ? 'Événements illimités + filtres avancés + sans publicité' : `${subStatus?.remaining || 3} événement${(subStatus?.remaining || 3) > 1 ? 's' : ''} restant${(subStatus?.remaining || 3) > 1 ? 's' : ''}`}
              </Text>
            </View>
            <TouchableOpacity 
          ...
          <View style={{ marginTop: 24 }}>
            <Text style={[s.subLabel, { marginBottom: 10 }]}>LÉGAL</Text>
            <TouchableOpacity
              onPress={() => go('privacyPolicy')}
              style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: C.card, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: C.border }}
            >
              <Ionicons name="shield-checkmark-outline" size={18} color={C.primary} />
              <Text style={{ flex: 1, marginLeft: 10, fontWeight: '700', fontSize: 13, color: C.dark }}>Politique de confidentialité</Text>
              <Ionicons name="chevron-forward" size={16} color={C.light} />
            </TouchableOpacity>
          </View>

          <View style={{ marginTop: 20, marginBottom: 8 }}>
            <Text style={[s.subLabel, { marginBottom: 10 }]}>COMPTE</Text>
            <TouchableOpacity
              onPress={() => setShowLogoutConfirm(true)}
              style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: C.card, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: C.border, marginBottom: 10 }}
            >
              <Ionicons name="log-out-outline" size={18} color={C.dark} />
              <Text style={{ flex: 1, marginLeft: 10, fontWeight: '700', fontSize: 13, color: C.dark }}>Se déconnecter</Text>
              <Ionicons name="chevron-forward" size={16} color={C.light} />
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => setShowDeleteAccountConfirm(true)}
              style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#FEE2E2', borderRadius: 14, padding: 14, borderWidth: 1, borderColor: '#FCA5A5' }}
            >
              <Ionicons name="trash-outline" size={18} color={C.danger} />
              <Text style={{ flex: 1, marginLeft: 10, fontWeight: '700', fontSize: 13, color: C.danger }}>Supprimer mon compte</Text>
      ...
      <Modal visible={showLogoutConfirm} transparent animationType="fade" onRequestClose={() => setShowLogoutConfirm(false)}>
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', padding: 24 }}>
          <View style={{ backgroundColor: C.card, borderRadius: 20, padding: 20 }}>
            <View style={{ alignItems: 'center', marginBottom: 12 }}>
              <View style={{ width: 52, height: 52, borderRadius: 26, backgroundColor: C.chip, alignItems: 'center', justifyContent: 'center', marginBottom: 12 }}>
                <Ionicons name="log-out-outline" size={24} color={C.primary} />
              </View>
              <Text style={{ fontSize: 16, fontWeight: '800', color: C.dark, textAlign: 'center' }}>Se déconnecter ?</Text>
              <Text style={{ color: C.gray, fontSize: 13, textAlign: 'center', marginTop: 6 }}>
            ...
            <View style={{ flexDirection: 'row', gap: 10, marginTop: 8 }}>
              ...
              <TouchableOpacity
                ...
                style={{ flex: 1, backgroundColor: C.primary, borderRadius: 999, paddingVertical: 14, alignItems: 'center' }}
              >
                <Text style={{ color: '#fff', fontWeight: '800', fontSize: 13 }}>Se déconnecter</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
      ...
      <Modal visible={showDeleteAccountConfirm} transparent animationType="fade" onRequestClose={() => setShowDeleteAccountConfirm(false)}>
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', padding: 24 }}>
          <View style={{ backgroundColor: C.card, borderRadius: 20, padding: 20 }}>
            <View style={{ alignItems: 'center', marginBottom: 12 }}>
              <View style={{ width: 52, height: 52, borderRadius: 26, backgroundColor: '#FEE2E2', alignItems: 'center', justifyContent: 'center', marginBottom: 12 }}>
              ...
              <Text style={{ fontSize: 16, fontWeight: '800', color: C.dark, textAlign: 'center' }}>Supprimer définitivement ton compte ?</Text>
              <Text style={{ color: C.gray, fontSize: 13, textAlign: 'center', marginTop: 6, lineHeight: 18 }}>
                Ton profil, ton historique de pratique, ton journal nutritionnel, tes amis et toutes tes données seront effacés de cet appareil. Cette action est irréversible.
              </Text>
            </View>
            <View style={{ flexDirection: 'row', gap: 10, marginTop: 8 }}>
              <TouchableOpacity
...
// Marques nationales courantes + enseignes / marques de magasin (pour l'autocomplétion
// du champ "Marque" en saisie manuelle dans Nutrition).
const BRANDS = [
  // ---- Marques nationales / industrielles ----
  "Nutella", "Ferrero", "Kinder", "Kinder Bueno", "KitKat", "Nestlé", "Oreo", "Mondelez",
  "Coca-Cola", "Pepsi", "Fanta", "Sprite", "Orangina", "Oasis", "Schweppes", "Red Bull",
  "Perrier", "Vittel", "Evian", "Volvic", "Badoit", "Contrex", "Cristaline", "San Pellegrino",
  "Ricoré", "Nesquik", "Lipton", "Innocent", "Alter Eco",
  "M&M's", "Twix", "Bounty", "Lion", "Mars", "Snickers", "Toblerone", "Daim", "Crunch",
  "Milka", "Lindt", "Côte d'Or", "Suchard", "Poulain", "Valrhona", "Cémoi",
  "Vache qui rit", "Kiri", "Babybel", "Boursin", "Philadelphia", "St Môret", "Président",
  "Elle & Vire", "Bridel", "Paysan Breton", "Roquefort Société",
  "Danone", "Danette", "Danonino", "Activia", "Actimel", "Yop", "Fjord",
  "Yoplait", "Petit Filous", "Panier de Yoplait", "Gervita", "Pom'Potes", "Materne", "Andros",
  "Bonne Maman", "Bledina", "Blédina", "Nestlé Bébé",
  "Amora", "Heinz", "Lesieur", "Puget", "Maille", "Knorr", "Maggi",
  "Barilla", "Panzani", "Lustucru", "Rivoire & Carret", "Buitoni",
  "Uncle Ben's", "Taureau Ailé", "Alsa",
  "Chocapic", "Miel Pops", "Frosties", "Spécial K", "All-Bran", "Kellogg's", "Cheerios",
  "Heudebert", "Harrys", "Jacquet", "Pasquier", "LU", "Bahlsen", "BN", "Prince", "Belvita",
  "McCain", "Findus", "Marie", "Sodebo", "Fleury Michon", "Herta", "Charal", "Bigard",
  "William Saurin", "Cocotte", "Petit Navire", "Connétable", "Saupiquet", "Parmentine",
  "Picard", "Thiriet", "Häagen-Dazs", "Ben & Jerry's", "Carte d'Or", "La Laitière",
  "Bjorg", "Léa Nature", "Jardin Bio",
  // ---- Enseignes / marques de magasin (MDD) ----
  "Carrefour", "Carrefour Bio", "Carrefour Classic'",
  "Leclerc", "Marque Repère", "Bio Village",
  "Auchan", "Auchan Bio", "Rik & Rok",
  "Intermarché", "Pâturages", "Monique Ranou",
  "Système U", "U", "U Bio",
  "Casino", "Casino Bio", "Terre & Saveur",
  "Monoprix", "Monoprix Bio", "Monoprix Gourmet",
  "Lidl", "Aldi", "Cora", "Franprix", "G20", "Netto", "Grand Frais",
  "Biocoop", "Naturalia",
];

function searchBrands(query) {
  if (!query || query.trim().length < 1) return [];
  const q = normalizeDishKey(query);
  return BRANDS
    .map((b) => {
      const bn = normalizeDishKey(b);
      let score = 0;
      if (bn === q) score = 100;
      else if (bn.startsWith(q)) score = 80;
...
function NutritionScreen({ go, goBack }) {
  ...
  const [manual, setManual] = useState({ dish: '', brand: '', portion_g: '200', portions: '1', portionWeightG: '200', kcal: '', protein_g: '', carbs_g: '', fat_g: '' });
  ...
  // Suggestions de marques dès qu'on commence à taper dans le champ Marque
  useEffect(() => {
    if (manual.brand.trim().length > 0) {
      const results = searchBrands(manual.brand);
  ...
  const addToLog = async (entry) => {
    ...
    setManual({ dish: '', brand: '', portion_g: '200', portions: '1', portionWeightG: '200', kcal: '', protein_g: '', carbs_g: '', fat_g: '' });
    setShowSuggestions(false);
  };
  ...
  const confirmDeleteMeal = async () => {
    if (!deleteTarget) return;
    await removeFromLog(deleteTarget.id);
    setDeleteTarget(null);
  };
      ...
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        ...
        {showAddForm ? (
          <View style={{ backgroundColor: C.card, borderRadius: 18, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: C.border }}>
            ...
            <Text style={[s.subLabel, { marginBottom: 6, marginTop: 10 }]}>MARQUE (optionnel)</Text>
            <TextInput 
              style={s.input} 
              placeholder="Ex: Nutella, Carrefour, Danone..." 
              placeholderTextColor={C.light}
              value={manual.brand} 
              onChangeText={(v) => setManual({ ...manual, brand: v })} 
              onFocus={() => setShowBrandSuggestions(brandSuggestions.length > 0)}
            />
            ...
            {showBrandSuggestions && brandSuggestions.length > 0 ? (
              <View style={{
                ...
                {brandSuggestions.map((b) => (
                  <TouchableOpacity
                    key={b.name}
                    onPress={() => { setManual({ ...manual, brand: b.name }); setShowBrandSuggestions(false); }}
                    style={{
                      flexDirection: 'row',
                      alignItems: 'center',
                      paddingVertical: 10,
                  ...
                  >
                    ...
                    <Text style={{ marginLeft: 10, fontWeight: '600', fontSize: 13, color: C.dark }}>{b.name}</Text>
                  </TouchableOpacity>
                ))}
              </View>
            ) : null}
          ...
          log.map((m) => (
            <View key={m.id} style={s.mealRow}>
              <View style={{ flex: 1 }}>
                ...
                {m.brand ? <Text style={{ color: C.primary, fontSize: 11, fontWeight: '700', marginTop: 1 }}>{m.brand}</Text> : null}
                <Text style={s.mealMeta}>
                  {m.portion_g}g · {m.kcal} kcal · P {m.protein_g}g · G {m.carbs_g}g · L {m.fat_g}g
                </Text>
              </View>
              <TouchableOpacity onPress={() => setDeleteTarget(m)}>
        ...
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', padding: 24 }}>
          <View style={{ backgroundColor: C.card, borderRadius: 20, padding: 20 }}>
            <View style={{ alignItems: 'center', marginBottom: 12 }}>
              ...
              <Text style={{ fontSize: 16, fontWeight: '800', color: C.dark, textAlign: 'center' }}>Supprimer cet aliment ?</Text>
              {deleteTarget ? (
                <Text style={{ color: C.gray, fontSize: 13, textAlign: 'center', marginTop: 6, lineHeight: 18 }}>
                  {deleteTarget.dish}{deleteTarget.brand ? ` (${deleteTarget.brand})` : ''} · {deleteTarget.kcal} kcal
                  {'\n'}Cette action est définitive.
                </Text>
              ) : null}
            </View>
...
export default function App() {
  ...
  // authUser === {...} -> utilisateur connecté (uid + profil Firestore)
  const [authUser, setAuthUser] = useState(undefined);

  useEffect(() => {
    let done = false;
    // Filet de sécurité : si Firebase ne répond pas (connexion coupée au démarrage),
    // on ne reste pas bloqué sur l'écran de chargement indéfiniment.
    ...
    // onAuthStateChanged est déclenché automatiquement par Firebase dès qu'une session
    // persistée est retrouvée au démarrage, ou après une connexion/déconnexion.
    const unsubscribe = auth.onAuthStateChanged(async (fbUser) => {
      ...
      try {
        ...
        setAuthUser({ uid: fbUser.uid, email: fbUser.email, ...profile });
      } catch (e) {
        done = true;
  ...
  // Déconnexion : ferme la session Firebase et repasse par AuthScreen.
